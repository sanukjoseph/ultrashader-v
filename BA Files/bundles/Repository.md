...
## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — LEGEND

```csv
Legend,
,
,New tables (Tab colour)
,"Primary key, Seq No"
,New Columns to be added
,Mandatory columns to be added in all tables
,Columns that are reused for 837I Inst mapping
,Existing columns only for  837P mapping
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM

```csv
SUBMITTED_CLAIM,Data Type,Length(Min-Max),Comments
SUBMITTED_CLAIM_KEY,VARCHAR,1-50,
CLAIM_FACT_KEY,NUMERIC,0-19,
CLAIM_HCC_ID,VARCHAR,1-30,
BILLING_PROVIDER_CONTACT_NAME,VARCHAR,1-60,
RENDERING_PROVIDER_LAST_NAME,VARCHAR,1-60,
RENDERING_PROVIDER_FIRST_NAME,VARCHAR,1-35,
RENDERING_PROVIDER_MIDDLE_NAME,VARCHAR,1-25,
RENDERING_PROVIDER_NAME_SUFFIX,VARCHAR,1-10,
RENDERING_PROVIDER_ID,VARCHAR,2-80,
AMBULANCE_TRANSPORT_STRETCHER_PURPOSE,VARCHAR,1-80,
AMBULANCE_DROPOFF_LOCATION_NAME,VARCHAR,1-60,
CREATED_TIME,DATETIME,,
LAST_MODIFIED_TIME,DATETIME,,
SUBMITTER_NAME,VARCHAR,1-60,
SUBMITTER_IDENTIFICATION_CODE,VARCHAR,2-80,
CLAIM_SUBMITTERS_IDENTIFIER,VARCHAR,1-38,
CLAIM_AMOUNT,VARCHAR,1-18,
CLAIM_FACILITY_CODE,VARCHAR,1-2,
CLAIM_FREQUENCY_TYPE,VARCHAR,1-1,
PROVIDER_SIGNATURE_IND,VARCHAR,1-1,
PROVIDER_ACCEPT_ASSIGNEMNT_CODE,VARCHAR,1-1,
BENEFIT_ASSIGNMENT_IND,VARCHAR,1-1,
RELEASE_INFO_CODE,VARCHAR,1-1,
TREATMENT_START_DT,VARCHAR,1-35,
ADMISSION_DATE,VARCHAR,1-35,
DISCHARGE_DATE,VARCHAR,1-35,
PATIENT_AMOUNT_PAID,VARCHAR,1-18,
DIAGNOSIS_CODE1,VARCHAR,1-30,
DIAGNOSIS_CODE2,VARCHAR,1-30,
DIAGNOSIS_CODE3,VARCHAR,1-30,
DIAGNOSIS_CODE4,VARCHAR,1-30,
DIAGNOSIS_CODE5,VARCHAR,1-30,
DIAGNOSIS_CODE5,VARCHAR,1-30,
DIAGNOSIS_CODE7,VARCHAR,1-30,
DIAGNOSIS_CODE8,VARCHAR,1-30,
DIAGNOSIS_CODE9,VARCHAR,1-30,
DIAGNOSIS_CODE10,VARCHAR,1-30,
DIAGNOSIS_CODE11,VARCHAR,1-30,
DIAGNOSIS_CODE12,VARCHAR,1-30,
HCC_CLAIM_NUMBER,VARCHAR,1-50,
CLEARINGHOUSE_TRACE_NUMBER,VARCHAR,1-50,
ANESTHESIA_CODE,VARCHAR,1-30,
CLAIM_CREATION_DATE,VARCHAR,8-8,BHT04
CLAIM_CREATION_TIME,VARCHAR,4-8,BHT05
RECEIVER_NAME,VARCHAR,1-60,1000B.NM103
RECEIVER_IDENTIFICATION_CODE,VARCHAR,1-80,1000B.NM109
PAY_TO_ADDRESS_1,VARCHAR,1-55,
PAY_TO_ADDRESS_2,VARCHAR,1-55,
PAY_TO_ADDRESS_CITY,VARCHAR,2-30,
PAY_TO_ADDRESS_STATE_NAME,VARCHAR,2-2,
PAY_TO_ADDRESS_POSTAL_CODE,VARCHAR,3-15,
PAY_TO_ADDRESS_COUNTRY_CODE,VARCHAR,2-3,
STATEMENT_DATE,VARCHAR,1-35,
ADMISSION_TYPE_CODE,VARCHAR,1-1,
ADMISSION_SOURCE_CODE,VARCHAR,1-1,
PATIENT_STATUS_CODE,VARCHAR,1-2,
CONTRACT_TYPE_CODE,VARCHAR,2-2,
CONTRACT_AMOUNT,VARCHAR,1-18,
CONTRACT_PERCENTAGE,VARCHAR,1-6,
PATIENT_ESTIMATED_AMOUNT_DUE,VARCHAR,1-18,
PRIOR_AUTHORIZATION,VARCHAR,1-50,
AUTO_ACCIDENT_STATE,VARCHAR,1-50,
MEDICAL_RECORD_NUMBER,VARCHAR,1-50,
CLAIM_NOTE,VARCHAR,1-80,
BILLING_NOTE,VARCHAR,1-80,
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_AMBULANCE_CERTI

```csv
SUBMITTED_CLAIM_AMBULANCE_CERTIFICATION,Data Type,Length(Min-Max)
SUBMITTED_CLAIM_KEY,VARCHAR,1-50
SEQ_NO,NUMERIC,0-3
CLAIM_FACT_KEY,NUMERIC,0-19
CLAIM_HCC_ID,VARCHAR,1-30
CONDITION_CODE_APPLIES_INDICATOR,VARCHAR,1-1
CONDITION_CODE_1,VARCHAR,2-3
CONDITION_CODE_2,VARCHAR,2-3
CONDITION_CODE_3,VARCHAR,2-3
CONDITION_CODE_4,VARCHAR,2-3
CONDITION_CODE_5,VARCHAR,2-3
CREATED_TIME,DATETIME,
LAST_MODIFIED_TIME,DATETIME,
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_BILLINGPROVIDER

```csv
SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,Data Type,Length(Min-Max),
SUBMITTED_CLAIM_KEY,VARCHAR,1-50,
SEQ_NO,NUMERIC,0-3,
CLAIM_FACT_KEY,NUMERIC,0-19,
CLAIM_HCC_ID,VARCHAR,1-30,
BILLING_PROVIDER_REFERENCE_IDENTIFIER,VARCHAR,2-3,
BILLING_PROVIDER_TAXONOMY_CODE,VARCHAR,1-50,
BILLING_PROVIDER_LAST_NAME,VARCHAR,1-60,
BILLING_PROVIDER_FIRST_NAME,VARCHAR,1-35,
BILLING_PROVIDER_MIDDLE_NAME,VARCHAR,1-25,
BILLING_PROVIDER_NAME_SUFFIX,VARCHAR,1-10,
BILLING_PROVIDER_IDENTIFIER,VARCHAR,2-80,
CREATED_TIME,DATETIME,,
LAST_MODIFIED_TIME,DATETIME,,
BILLING_PROVIDER_ADDRESS_1,VARCHAR,1-55,2010AA.N301
BILLING_PROVIDER_ADDRESS_2,VARCHAR,1-55,2010AA.N302
BILLING_PROVIDER_CITY,VARCHAR,2-30,2010AA.N401
BILLING_PROVIDER_STATE_CODE,VARCHAR,2-2,2010AA.N402
BILLING_PROVIDER_POSTAL_CODE,VARCHAR,3-15,2010AA.N403
BILLING_PROVIDER_COUNTRY_CODE,VARCHAR,2-3,2010AA.N404
BILLING_PROVIDER_TAX_IDENTIFICATION_NUMBER,VARCHAR,1-50,2010AA.REF02
BILLING_PROVIDER_CONTACT_INFO,VARCHAR,1-256,2010AA.PER04
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_LINE

```csv
SUBMITTED_CLAIM_LINE,Data Type,Length(Min-Max)
SUBMITTED_CLAIM_KEY,VARCHAR,1-50
SUBMITTED_LINE_NUMBER,VARCHAR,1-50
CLAIM_FACT_KEY,NUMERIC,0-19
CLAIM_HCC_ID,VARCHAR,1-30
CLAIM_LINE_FACT_KEY,NUMERIC,0-19
CLAIM_LINE_HCC_ID,VARCHAR,1-30
OPERATING_PHYSICIAN_LAST_NAME,VARCHAR,1-60
OPERATING_PHYSICIAN_FIRST_NAME,varchar(35),1-35
OPERATING_PHYSICIAN_MIDDLE_NAME,varchar(25),1-25
OPERATING_PHYSICIAN_NAME_SUFFIX,varchar(10),1-10
OPERATING_PHYSICIAN_IDENTIFIER,varchar(80),2-80
OTHER_OPERATING_PHYSICIAN_LAST_NAME,varchar(60),1-60
OTHER_OPERATING_PHYSICIAN_FIRST_NAME,varchar(35),1-35
OTHER_OPERATING_PHYSICIAN_MIDDLE_NAME,varchar(25),1-25
OTHER_OPERATING_PHYSICIAN_NAME_SUFFIX,varchar(10),1-10
OTHER_OPERATING_PHYSICIAN_IDENTIFIER,varchar(80),2-80
RENDERING_PROVIDER_LAST_NAME,VARCHAR,1-60
RENDERING_PROVIDER_FIRST_NAME,VARCHAR,1-35
RENDERING_PROVIDER_MIDDLE_NAME,VARCHAR,1-25
RENDERING_PROVIDER_NAME_SUFFIX,VARCHAR,1-10
RENDERING_PROVIDER_IDENTIFIER,VARCHAR,2-80
REFERRING_PROVIDER_LAST_NAME,VARCHAR,1-60
REFERRING_PROVIDER_FIRST_NAME,VARCHAR,1-35
REFERRING_PROVIDER_MIDDLE_NAME,VARCHAR,1-25
REFERRING_PROVIDER_NAME_SUFFIX,VARCHAR,1-10
REFERRING_PROVIDER_IDENTIFIER,VARCHAR,2-80
AMBULANCE_PATIENT_COUNT,VARCHAR,1-15
AMBULANCE_DROPOFF_LOCATION_NAME,VARCHAR,1-60
SERVICE_CODE,VARCHAR,1-48
PROCEDURE_MOD_1,VARCHAR,2-2
PROCEDURE_MOD_2,VARCHAR,2-2
PROCEDURE_MOD_3,VARCHAR,2-2
PROCEDURE_MOD_4,VARCHAR,2-2
LINE_ITEM_AMOUNT,VARCHAR,1-18
LINE_ITEM_QUANTITY,VARCHAR,1-15
LINE_SERVICE_DT,VARCHAR,1-35
LINE_ITEM_UNITS,VARCHAR,2-2
CREATED_TIME,DATETIME,
LAST_MODIFIED_TIME,DATETIME,
SERVICE_LINE_REVENUE_CODE,VARCHAR,1-48
NON_CONVERED_CHARGE_AMOUNT,VARCHAR,1-18
LINE_NOTE_TEXT,VARCHAR,1-80
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_LINE_AMBULANCE_

```csv
SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,Data Type,Length(Min-Max)
SUBMITTED_CLAIM_KEY,VARCHAR,1-50
SUBMITTED_LINE_NUMBER,VARCHAR,1-6
SEQ_NO,NUMERIC,0-3
CLAIM_FACT_KEY,NUMERIC,0-19
CLAIM_HCC_ID,VARCHAR,1-30
CLAIM_LINE_FACT_KEY,NUMERIC,0-19
...
CONDITION_CODE_4,VARCHAR,2-3
CONDITION_CODE_5,VARCHAR,2-3
PATIENT_WEIGHT,VARCHAR,1-10
AMB_REASON_CODE,VARCHAR,1-1
AMB_UNITS,VARCHAR,2-2
AMB_TRANSPORT_DISTANCE,VARCHAR,1-15
AMB_PURPOSE_DESC,VARCHAR,1-80
AMB_PICKUP_ADD_1,VARCHAR,1-55
AMB_PICKUP_ADD_2,VARCHAR,1-55
AMB_PICKUP_ADD_CITY,VARCHAR,2-30
AMB_PICKUP_ADD_STATE,VARCHAR,2-2
AMB_PICKUP_ADD_ZIP,VARCHAR,3-15
AMB_PICKUP_ADD_COUNTRY,VARCHAR,2-3
AMB_DROPOFF_ADD_1,VARCHAR,1-55
AMB_DROPOFF_ADD_2,VARCHAR,1-55
AMB_DROPOFF_ADD_CITY,VARCHAR,2-30
AMB_DROPOFF_ADD_STATE,VARCHAR,2-2
AMB_DROPOFF_ADD_ZIP,VARCHAR,3-15
AMB_DROPOFF_ADD_COUNTRY,VARCHAR,2-3
CREATED_TIME,DATETIME,
LAST_MODIFIED_TIME,DATETIME,
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_MEDICARE_INPATI

```csv
SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,Data Type,Length(Min-Max)
SUBMITTED_CLAIM_KEY,VARCHAR,1-50
SEQ_NO,NUMERIC,0-3
CLAIM_FACT_KEY,NUMERIC,0-19
CLAIM_HCC_ID,VARCHAR,1-30
COVERED_DAYS_OR_VISITS_COUNT,VARCHAR,15
LIFETIME_PSYCHIATRIC_DAYS_COUNT,VARCHAR,15
CLAIM_DRG_AMOUNT,VARCHAR,18
CLAIM_PAYMENT_REMARK_CODE,VARCHAR,50
CLAIM_DISPROPORTIONATE_SHARE_AMOUNT,VARCHAR,18
CLAIM_MSP_PASS_THROUGH_AMOUNT,VARCHAR,18
CLAIM_PPS_CAPITAL_AMOUNT,VARCHAR,18
PPS_CAPITAL_FSP_DRG_AMOUNT,VARCHAR,18
PPS_CAPITAL_HSP_DRG_AMOUNT,VARCHAR,18
PPS_CAPITAL_DSH_DRG_AMOUNT,VARCHAR,18
OLD_CAPITAL_AMOUNT,VARCHAR,18
PPS_CAPITAL_IME_AMOUNT,VARCHAR,18
PPS_OPERATING_HOSPITAL_SPECIFIC_DRG_AMOUNT,VARCHAR,18
COST_REPORT_DAY_COUNT,VARCHAR,15
PPS_OPERATING_FEDERAL_SPECIFIC_DRG_AMOUNT,VARCHAR,18
CLAIM_PPS_CAPITAL_OUTLIER_AMOUNT,VARCHAR,18
CLAIM_INDIRECT_TEACHING_AMOUNT,VARCHAR,18
NON_PAYABLE_PROFESSIONAL_COMPONENT_BILLED_AMOUNT,VARCHAR,18
CLAIM_PAYMENT_REMARK_CODE_1,VARCHAR,50
CLAIM_PAYMENT_REMARK_CODE_2,VARCHAR,50
CLAIM_PAYMENT_REMARK_CODE_3,VARCHAR,50
CLAIM_PAYMENT_REMARK_CODE_4,VARCHAR,50
PPS_CAPITAL_EXCEPTION_AMOUNT,VARCHAR,18
CREATED_TIME,DATETIME,
LAST_MODIFIED_TIME,DATETIME,
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_MEDICARE_OUTPAT

```csv
SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO,Data Type,Length(Min-Max)
SUBMITTED_CLAIM_KEY,VARCHAR,1-50
SEQ_NO,NUMERIC,0-3
CLAIM_FACT_KEY,NUMERIC,0-19
CLAIM_HCC_ID,VARCHAR,1-30
REIMBURSEMENT_RATE,VARCHAR,1-10
HCPCS_PAYABLE_AMOUNT,VARCHAR,1-18
CLAIM_PAYMENT_REMARK_CODE_1,VARCHAR,1-50
CLAIM_PAYMENT_REMARK_CODE_2,VARCHAR,1-50
CLAIM_PAYMENT_REMARK_CODE_3,VARCHAR,1-50
CLAIM_PAYMENT_REMARK_CODE_4,VARCHAR,1-50
CLAIM_PAYMENT_REMARK_CODE_5,VARCHAR,1-50
ESRD_PAYMENT_AMOUNT,VARCHAR,1-18
NON_PAYABLE_PROF_COMP_BILLED_AMOUNT,VARCHAR,1-18
CREATED_TIME,DATETIME,
LAST_MODIFIED_TIME,DATETIME,
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_OTHER_PAYER

```csv
SUBMITTED_CLAIM_OTHER_PAYER,Data Type,Length(Min-Max)
SUBMITTED_CLAIM_KEY,VARCHAR,1-50
SEQ_NO,NUMERIC,0-3
CLAIM_FACT_KEY,NUMERIC,0-19
CLAIM_HCC_ID,VARCHAR,1-30
ADJUDICATION_OR_PAYMENT_DATE,VARCHAR,1-35
OTHER_PAYER_PRIMARY_IDENTIFIER,VARCHAR,2-80
CLAIM_PAYER_NAME,VARCHAR,1-60
CLAIM_OTHER_PAYER_NAME,VARCHAR,1-60
CLAIM_OTHER_PAYER_ADD_1,VARCHAR,1-55
CLAIM_OTHER_PAYER_ADD_2,VARCHAR,1-55
CLAIM_OTHER_PAYER_CITY,VARCHAR,2-30
CLAIM_OTHER_PAYER_STATE,VARCHAR,2-2
CLAIM_OTHER_PAYER_ZIP,VARCHAR,3-15
CLAIM_OTHER_PAYER_COUNTRY,VARCHAR,2-3
CREATED_TIME,DATETIME,
LAST_MODIFIED_TIME,DATETIME,
CLAIM_OTHER_PAYER_CONTROL_NUMBER,VARCHAR,1-50
CLAIM_PAYER_IDENTIFICATION_CODE,VARCHAR,2-80
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_OTHER_SUBSCRIBE

```csv
SUBMITTED_CLAIM_OTHER_SUBSCRIBER,Data Type,Length(Min-Max)
SUBMITTED_CLAIM_KEY,VARCHAR,1-50
SEQ_NO,NUMERIC,0-3
CLAIM_FACT_KEY,NUMERIC,0-19
CLAIM_HCC_ID,VARCHAR,1-30
RELATIONSHIP_TO_INSURED,VARCHAR,2-2
BENEFITS_ASSIGNMENT_CERTIFICATION_INDICATOR,VARCHAR,1-1
INFORMATION_RELEASE_CERTIFICATION_INDICATOR,VARCHAR,1-1
OTHER_INSURED_ADDRESS_LINE_1,VARCHAR,1-55
OTHER_INSURED_ADDRESS_LINE_2,VARCHAR,1-55
OTHER_INSURED_CITY,VARCHAR,2-30
OTHER_INSURED_STATE,VARCHAR,2-2
OTHER_INSURED_ZIP,VARCHAR,3-15
OTHER_INSURED_ADDITIONAL_IDENTIFIER,VARCHAR,1-50
PAYER_AMOUNT_PAID,VARCHAR,1-18
NONCOVERED_CHARGES,VARCHAR,1-18
OTHER_INSURED_LAST_NAME,VARCHAR,1-60
OTHER_INSURED_FIRST_NAME,VARCHAR,1-35
OTHER_INSURED_MIDDLE_NAME,VARCHAR,1-25
OTHER_INSURED_NAME_SUFFIX,VARCHAR,1-10
OTHER_INSURED_INDENTIFICATION_CODE,VARCHAR,2-80
CREATED_TIME,DATETIME,
LAST_MODIFIED_TIME,DATETIME,
REMAINING_PATIENT_LIABILITY,VARCHAR,1-18
INSURED_GROUP_NUMBER,VARCHAR,1-50
OTHER_INSURED_GROUP_NAME,VARCHAR,1-60
CLAIM_FILLING_INDICATOR,VARCHAR,1-2
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_REPORT_TABLE

```csv
SUBMITTED_CLAIM_REPORT_TABLE,Data Type,Length(Min-Max)
SUBMITTED_CLAIM_KEY,VARCHAR,1-50
CLAIM_TYPE,VARCHAR,0-50
STAGING_TABLE_LOAD_STATUS,VARCHAR,0-50
SOURCE_DATA_CREATED_TIME,DATETIME,
FILE_NAME,VARCHAR,
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_SUBSCRIBER_DETA

```csv
SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,Data Type,Length(Min-Max),Comments
SUBMITTED_CLAIM_KEY,VARCHAR,1-50,
SEQ_NO,NUMERIC,0-3,
CLAIM_FACT_KEY,NUMERIC,0-19,
CLAIM_HCC_ID,VARCHAR,1-30,
SUBSCRIBER_RELATIONSHIP_CODE,VARCHAR,2-2,
SUBSCRIBER_POLICY_NUMBER,VARCHAR,1-50,
SUBSCRIBER_GROUP_NAME,VARCHAR,1-60,
SUBSCRIBER_INSURANCE_TYPE_CODE,VARCHAR,1-3,
SUBSCRIBER_FILING_INDICATOR,VARCHAR,1-2,
SUBSCRIBER_LAST_NAME,VARCHAR,1-60,
SUBSCRIBER_FIRST_NAME,VARCHAR,1-35,
SUBSCRIBER_MIDDLE_NAME,VARCHAR,1-25,
SUBSCRIBER_NAME_SUFFIX,VARCHAR,1-10,
SUBSCRIBER_ADDRESS_1,VARCHAR,1-55,
SUBSCRIBER_ADDRESS_CITY,VARCHAR,2-30,
SUBSCRIBER_ADDRESS_STATE,VARCHAR,2-2,
SUBSCRIBER_ADDRESS_ZIP,VARCHAR,3-15,
SUBSCRIBER_ADDRESS_COUNTRY,VARCHAR,2-3,
SUBSCRIBER_BIRTH_DATE,VARCHAR,1-8,
SUBSCRIBER_GENDER,VARCHAR,1-1,
SUBSCRIBER_PHONE_NUMBER_1,VARCHAR,1-256,
SUBSCRIBER_PHONE_NUMBER_2,VARCHAR,1-256,
CREATED_TIME,DATETIME,,
LAST_MODIFIED_TIME,DATETIME,,
SUBSCRIBER_IDENTIFICATION_CODE,VARCHAR,2-80,2010BA.NM109
SUBSCRIBER_ADDRESS_2,VARCHAR,1-55,2010BA.N302
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_PATIENT_DETAILS

```csv
SUBMITTED_CLAIM_PATIENT_DETAILS,Data Type,Length(Min-Max),
SUBMITTED_CLAIM_KEY,VARCHAR,1-50,
SEQ_NO,NUMERIC,0-3,
CLAIM_FACT_KEY,NUMERIC,0-19,
CLAIM_HCC_ID,VARCHAR,1-30,
PATIENT_SUBS_RELATIONSHIP,VARCHAR,2-2,
PATIENT_DEATH_DATE,VARCHAR,1-35,
PATIENT_UNIT,VARCHAR,2-2,
PATIENT_WEIGHT,VARCHAR,1-10,
PATIENT_PREGNANCY_INDICATOR,VARCHAR,1-1,
PATIENT_LAST_NAME,VARCHAR,1-60,
PATIENT_FIRST_NAME,VARCHAR,1-35,
PATIENT_MIDDLE_NAME,VARCHAR,1-25,
PATIENT_NAME_SUFFIX,VARCHAR,1-10,
PATIENT_ADDRESS_1,VARCHAR,1-55,
PATIENT_ADDRESS_CITY,VARCHAR,2-30,
PATIENT_ADDRESS_STATE,VARCHAR,2-2,
PATIENT_ADDRESS_ZIP,VARCHAR,3-15,
PATIENT_ADDRESS_COUNTRY,VARCHAR,2-3,
PATIENT_BIRTH_DATE,VARCHAR,1-35,
PATIENT_GENDER,VARCHAR,1-1,
PATIENT_PHONE_NUMBER_1,VARCHAR,1-256,
PATIENT_PHONE_NUMBER_2,VARCHAR,1-256,
CREATED_TIME,DATETIME,,
LAST_MODIFIED_TIME,DATETIME,,
PATIENT_ADDRESS_2,VARCHAR,1-55,2010CA.N302
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_CLAIMLINE_OTHER

```csv
SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,Data Type,Length(Min-Max),Comments
SUBMITTED_CLAIM_KEY,VARCHAR,1-50,
SUBMITTED_LINE_NUMBER,VARCHAR,1-6,
SEQ_NO,NUMERIC,0-3,
CLAIM_FACT_KEY,NUMERIC,0-19,
CLAIM_HCC_ID,VARCHAR,1-30,
SERVICE_LINE_PAID_AMOUNT,VARCHAR,1-18,
CLAIM_LINE_REMITTENCE_DATE,VARCHAR,1-35,
SERVICE_LINE_ALLOWED_AMOUNT,VARCHAR,1-18,
DRUG_CODE,VARCHAR,2-2,
DRUG_PRODUCT_ID,VARCHAR,1-48,
DRUG_QUANTITY,VARCHAR,1-15,
DRUG_QUANTITY_MEASURE,VARCHAR,2-2,
CREATED_TIME,DATETIME,,
LAST_MODIFIED_TIME,DATETIME,,
REMAINING_PATIENT_LIABILITY,VARCHAR,1-18,
CLAIM_LINE_FACT_KEY,NUMERIC,0-19,
...
## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_LEVEL_ADJUSTMEN

```csv
SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,Data Type,Length(Min-Max)
SUBMITTED_CLAIM_KEY,VARCHAR,1-50
SEQ_NO,NUMERIC,0-3
CLAIM_FACT_KEY,NUMERIC,0-19
CLAIM_HCC_ID,VARCHAR,1-30
CLAIM_ADJUSTMENT_GROUP_CODE,VARCHAR,1-2
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_REASON_CODE_1,VARCHAR,1-5
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_AMT_1,VARCHAR,1-18
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_QTY_1,VARCHAR,1-15
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_REASON_CODE_2,VARCHAR,1-5
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_AMT_2,VARCHAR,1-18
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_QTY_2,VARCHAR,1-15
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_REASON_CODE_3,VARCHAR,1-5
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_AMT_3,VARCHAR,1-18
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_QTY_3,VARCHAR,1-15
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_REASON_CODE_4,VARCHAR,1-5
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_AMT_4,VARCHAR,1-18
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_QTY_4,VARCHAR,1-15
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_REASON_CODE_5,VARCHAR,1-5
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_AMT_5,VARCHAR,1-18
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_QTY_5,VARCHAR,1-15
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_REASON_CODE_6,VARCHAR,1-5
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_AMT_6,VARCHAR,1-18
CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_QTY_6,VARCHAR,1-15
CREATED_TIME,DATETIME,
LAST_MODIFIED_TIME,DATETIME,
OTHER_PAYER_PRIMARY_IDENTIFIER,VARCHAR,2-80
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_LINE_LEVEL_ADJU

```csv
SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,Data Type,Length(Min-Max)
SUBMITTED_CLAIM_KEY,VARCHAR,1-50
SUBMITTED_LINE_NUMBER,VARCHAR,1-6
SEQ_NO,NUMERIC,0-3
CLAIM_FACT_KEY,NUMERIC,0-19
CLAIM_HCC_ID,VARCHAR,1-30
CLAIM_LINE_ADJUSTMENT_GROUP_CODE,VARCHAR,1-2
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_REASON_CODE_1,VARCHAR,1-5
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_AMT_1,VARCHAR,1-18
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_QTY_1,VARCHAR,1-15
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_REASON_CODE_2,VARCHAR,1-5
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_AMT_2,VARCHAR,1-18
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_QTY_2,VARCHAR,1-15
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_REASON_CODE_3,VARCHAR,1-5
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_AMT_3,VARCHAR,1-18
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_QTY_3,VARCHAR,1-15
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_REASON_CODE_4,VARCHAR,1-5
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_AMT_4,VARCHAR,1-18
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_QTY_4,VARCHAR,1-15
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_REASON_CODE_5,VARCHAR,1-5
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_AMT_5,VARCHAR,1-18
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_QTY_5,VARCHAR,1-15
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_REASON_CODE_6,VARCHAR,1-5
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_AMT_6,VARCHAR,1-18
CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_QTY_6,VARCHAR,1-15
CREATED_TIME,DATETIME,
LAST_MODIFIED_TIME,DATETIME,
OTHER_PAYER_PRIMARY_IDENTIFIER,VARCHAR,2-80
CLAIM_LINE_FACT_KEY,NUMERIC,0-19
...
## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_PROVIDER_DETAIL

```csv
SUBMITTED_CLAIM_PROVIDER_DETAILS,Data Type,Length(Min-Max),
SUBMITTED_CLAIM_KEY,VARCHAR,1-50,
SEQ_NO,NUMERIC,0-3,
CLAIM_FACT_KEY,NUMERIC,0-19,
CLAIM_HCC_ID,VARCHAR,1-30,
CLAIMLVL_REFERRING_PROVIDER_LAST_NAME,VARCHAR,1-60,2310A.NM103
CLAIMLVL_REFERRING_PROVIDER_FIRST_NAME,VARCHAR,1-35,2310A.NM104
CLAIMLVL_REFERRING_PROVIDER_MIDDLE_NAME,VARCHAR,1-25,2310A.NM105
CLAIMLVL_REFERRING_PROVIDER_NAME_SUFFIX,VARCHAR,1-10,2310A.NM107
CLAIMLVL_REFERRING_PROVIDER_IDENTIFICATION_CODE,VARCHAR,2-80,2310A.NM109
CLAIMLVL_SERVICE_FACILITY_NAME,VARCHAR,1-60,2310C.NM103
CLAIMLVL_SERVICE_FACILITY_IDENTIFICATION_CODE,VARCHAR,2-80,2310C.NM109
CLAIMLVL_SERVICE_FACILITY_ADDRESS_1,VARCHAR,1-55,2310C.N301
CLAIMLVL_SERVICE_FACILITY_ADDRESS_2,VARCHAR,1-55,2310C.N302
CLAIMLVL_SERVICE_FACILITY_CITY_NAME,VARCHAR,2-30,2310C.N401
CLAIMLVL_SERVICE_FACILITY_STATE_CODE,VARCHAR,2-2,2310C.N402
CLAIMLVL_SERVICE_FACILITY_POSTAL_CODE,VARCHAR,3-15,2310C.N403
CLAIMLVL_SERVICE_FACILITY_COUNTRY_CODE,VARCHAR,2-3,2310C.N404
CREATED_TIME,DATETIME,,
LAST_MODIFIED_TIME,DATETIME,,
CLAIMLVL_ATTENDING_PROV_LAST_NAME,VARCHAR,1-60,
CLAIMLVL_ATTENDING_PROV_FIRST_NAME,VARCHAR,1-35,
CLAIMLVL_ATTENDING_PROV_MIDDLE_NAME,VARCHAR,1-25,
CLAIMLVL_ATTENDING_PROV_NAME_SUFFIX,VARCHAR,1-10,
CLAIMLVL_ATTENDING_PROV_IDENTIFICATION_CODE,VARCHAR,2-80,
CLAIMLVL_ATTENDING_PROV_SECONDARY_ID,VARCHAR,1-50,
CLAIMLVL_OPERATING_PHYSICIAN_LAST_NAME,VARCHAR,1-60,
CLAIMLVL_OPERATING_PHYSICIAN_FIRST_NAME,VARCHAR,1-35,
CLAIMLVL_OPERATING_PHYSICIAN_MIDDLE_NAME,VARCHAR,1-25,
CLAIMLVL_OPERATING_PHYSICIAN_NAME_SUFFIX,VARCHAR,1-10,
CLAIMLVL_OPERATING_PHYSICIAN_IDENTIFICATION_CODE,VARCHAR,2-80,
CLAIMLVL_OPERATING_PHYSICIAN_SECONDARY_ID,VARCHAR,1-50,
CLAIMLVL_OTHER_OPERATING_PHYSICIAN_LAST_NAME,VARCHAR,1-60,
CLAIMLVL_OTHER_OPERATING_PHYSICIAN_FIRST_NAME,VARCHAR,1-35,
CLAIMLVL_OTHER_OPERATING_PHYSICIAN_MIDDLE_NAME,VARCHAR,1-25,
CLAIMLVL_OTHER_OPERATING_PHYSICIAN_NAME_SUFFIX,VARCHAR,1-10,
CLAIMLVL_OTHER_OPERATING_PHYSICIAN_IDENTIFICATION_CODE,VARCHAR,2-80,
CLAIMLVL_OTHER_OPERATING_PHYSICIAN_SECONDARY_ID,VARCHAR,1-50,
```

## Repository/Claims/V26.1.1.0/Claims Repository - 837IP Table Mapping vs Column Names_V2.1.xlsx — SUBMITTED_CLAIM_DIAGNOSIS_INFO

```csv
SUBMITTED_CLAIM_DIAGNOSIS_INFO,,,,,
SUBMITTED_CLAIM_KEY,VARCHAR,1-50,,,
HI_SEQ_NO,NUMERIC,0-3,HI SEGMENTS,,
HI_MULTI_SEQ_NO,NUMERIC,0-3,HI MULTIPLE LOOP REPEAT,,
C200_SEQ_NO,NUMERIC,0-3,,,
CLAIM_FACT_KEY,NUMERIC,0-19,,,
CLAIM_HCC_ID,VARCHAR,1-30,,,
DIAGNOSIS_QUALIFIER,VARCHAR,1-3,,,
DIAGNOSIS_CODE,VARCHAR,1-30,,,
POA_INDICATOR,VARCHAR,1-1,,,
DATE_TIME_PERIOD,VARCHAR,1-35,,,
VALUE_CODE_AMOUNT,VARCHAR,1-18,,,
CREATED_TIME,DATETIME,,,,
LAST_MODIFIED_TIME,DATETIME,,,,
,,,,,
,,,,,
...
## Repository/Claims/V26.1.1.0/EdifecsProduct_MappingSpec_ClaimsRepo_837IP_EDI_to_DFFConversion_V2.1.xlsx — Cover Page

```csv
Inbound Claims Repository Mapping Specification- EDIFECS,,,,,,,,,
,,,,,,,,,
Business Area: Inbound Claims Repository (EDI 837I/P),,,,,,,,,
,,,,,,,,,
This document provides the Mapping Specification for EDI 837I/P Claims Inbound Repository. Document is intended for EDIFECS Product Team,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,Version,,V26.1.1.0,,,
,,,,,,,,,
...
## Repository/Claims/V26.1.1.0/EdifecsProduct_MappingSpec_ClaimsRepo_837IP_EDI_to_DFFConversion_V2.1.xlsx — Version History
...
0.1,30/3/2023,UST HealthProof,Rameshwar Singh,Initial Version
0.2,2/4/2023,UST HealthProof,Rameshwar Singh,Made chnages as per review comments
0.3,2/4/2023,UST HealthProof,Rameshwar Singh,Baselined.
0.4,10-10-2024,UST HealthProof,Rameshwar Singh,837P - Enhancements as per latest requirements - PSD #3520
0.5,11/27/24,UST HealthProof,Rameshwar Singh,Updated 8 new fields in Orange - Column H
2,29/01/2025,Swedha Kumar,Ambily Raj,"Additional fields tables and column are added wrt PSD - 4847, 4763"
2.1,21/02/2025,Swedha Kumar,Ambily Raj,837I Mapping Enhancement
```

## Repository/Claims/V26.1.1.0/EdifecsProduct_MappingSpec_ClaimsRepo_837IP_EDI_to_DFFConversion_V2.1.xlsx — Tables

```csv
Integration Plus Staging Tables,ODS Tables,Loop.Segment,837I/P,Comments
USTILDB.SUBMITTED_CLAIM,CLAIM_SUBMITTED,,Both,
USTILDB.SUBMITTED_CLAIM_AMBULANCE_CERTIFICATION,CLAIM_SUBMITTED_AMBULANCE_CERTIFICATION,2300.CRC,837P,
USTILDB.SUBMITTED_CLAIM_LINE,CLAIM_SUBMITTED_LINE,,Both,
USTILDB.SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,CLAIM_SUBMITTED_LINE_AMBULANCE_CERTIFICATION,2400.CRC,837P,
USTILDB.SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,CLAIM_SUBMITTED_MEDICARE_INPATIENT_INFO,COB/2320.MIA,837I,
USTILDB.SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO,CLAIM_SUBMITTED_MEDICARE_OUTPATIENT_INFO,COB/2320.MOA,Both,
USTILDB.SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_SUBMITTED_OTHER_PAYER,COB/2330B,Both,
USTILDB.SUBMITTED_CLAIM_OTHER_SUBSCRIBER,CLAIM_SUBMITTED_OTHER_SUBSCRIBER,COB/2330A,Both,
SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,,,837P,
SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,,,837P,
SUBMITTED_CLAIM_PATIENT_DETAILS,,,837P,
SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,,,837P,
SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,837P,Not included as part of PSD - 3520
SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,,,837P,
SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,,,837P,
SUBMITTED_CLAIM_PROVIDER_DETAILS,,,Both,"Included as part of PSD - 4847, 4763"
SUBMITTED_CLAIM_DIAGNOSIS_INFO,,,837I,
```

## Repository/Claims/V26.1.1.0/EdifecsProduct_MappingSpec_ClaimsRepo_837IP_EDI_to_DFFConversion_V2.1.xlsx — Loop vs TableName

```csv
Loop,Description,Table Names,
1000A,SUBMITTER NAME,SUBMITTED_CLAIM,
1000B,RECEIVER NAME,SUBMITTED_CLAIM,
2000A,BILLING PROVIDER HIERARCHICAL LEVEL,CLAIM_BILLINGPROVIDER_DETAILS,
2010AA,BILLING PROVIDER NAME,CLAIM_BILLINGPROVIDER_DETAILS,
,,SUBMITTED_CLAIM,
2010AB,PAY-TO ADDRESS NAME,CLAIM_BILLINGPROVIDER_DETAILS,
2010AC,PAY-TO PLAN NAME,,
2000B,SUBSCRIBER HIERARCHICAL LEVEL,CLAIM_SUBSCRIBER_DETAILS,
2010BA,SUBSCRIBER NAME,CLAIM_SUBSCRIBER_DETAILS,
2010BB,PAYER NAME,SUBMITTED_CLAIM_OTHER_PAYER,
2000C,Patient Hierarchical Level,CLAIM_PATIENT_DETAILS,
2010CA,Patient Name,CLAIM_PATIENT_DETAILS,
2300,CLAIM INFORMATION,SUBMITTED_CLAIM,
,,SUBMITTED_CLAIM_AMBULANCE_CERTIFICATION,
2310A,REFERRING PROVIDER NAME,CLAIM_PROVIDER_DETAILS,
2310B,RENDERING PROVIDER NAME,CLAIM_PROVIDER_DETAILS,
2310C,SERVICE FACILITY LOCATION NAME,CLAIM_PROVIDER_DETAILS,
2310D,SUPERVISING PROVIDER NAME,,
2310E,AMBULANCE PICK-UP LOCATION,CLAIM_PROVIDER_DETAILS,
2310F,AMBULANCE DROP-OFF LOCATION,SUBMITTED_CLAIM,
,,CLAIM_PROVIDER_DETAILS,
2320,OTHER SUBSCRIBER INFORMATION,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,
,,CLAIM_LEVEL_ADJUSTMENTS,
,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO,
2330A,OTHER SUBSCRIBER NAME,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,
2330B,OTHER PAYER NAME,SUBMITTED_CLAIM_OTHER_PAYER,
...
2400,SERVICE LINE NUMBER,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,
,,SUBMITTED_CLAIM_LINE,
2410,DRUG IDENTIFICATION Drug identification,CLAIM_CLAIMLINE_OTHERDETAILS,
2420A,RENDERING PROVIDER NAME,SUBMITTED_CLAIM_PROVIDER_DETAILS,
2420B,PURCHASED SERVICE PROVIDER NAME,,
2420C,SERVICE FACILITY LOCATION NAME,SUBMITTED_CLAIM_PROVIDER_DETAILS,
2420D,SUPERVISING PROVIDER NAME,,
2420E,ORDERING PROVIDER NAME,,
2420F,REFERRING PROVIDER NAME,SUBMITTED_CLAIM_LINE,
2420G,AMBULANCE PICK-UP LOCATION,CLAIM_CLAIMLINE_OTHER,
2420H,AMBULANCE DROP-OFF LOCATION,SUBMITTED_CLAIM_LINE,
2430,LINE ADJUDICATION INFORMATION,CLAIM_CLAIMLINE_DETAILS,Check whether this is the loop with KS
2440,FORM IDENTIFICATION CODE,,
```

## Repository/Claims/V26.1.1.0/EdifecsProduct_MappingSpec_ClaimsRepo_837IP_EDI_to_DFFConversion_V2.1.xlsx — 837P

```csv
EDILoopID. Segment,EDI Data Element Name,EDI Element Description,Usage,Enumeration Values,Sample values,"Mapped to
Integration PlusTable Name.Column Name",Column Desc,Transformation Logic,COMMENTS
...
ISA06,Interchange Sender ID,Sender ID,R,<Sender ID>,,,,,
...
GS04,Date,Date the Group Header is created.,R,SysDate (CCYYMMDD),Example : 210630,,,,
...
Starts from 001 and increments with each transaction set",319003402,,,,
...
BHT04,Date,The date the transaction was created,R,SysDate (CCYYMMDD),20210630,SUBMITTED_CLAIM,CLAIM_CREATION_DATE,,
BHT05,Time,The time the transaction was created,R,SysTime (HHMMSS),173250,SUBMITTED_CLAIM,CLAIM_CREATION_TIME,,
...
2 : Non-person Entity",,,,,
1000A.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM,SUBMITTER_NAME,,
...
1000A.NM109,Identification Code,Code identifying a party or other code,R,100X,,SUBMITTED_CLAIM,SUBMITTER_IDENTIFICATION_CODE,,
...
1000B.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM,RECEIVER_NAME,,
1000B.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code",R,46 :  Electronic Transmitter Identification Number (ETIN,,,,,
1000B.NM109,Identification Code,Code identifying a party,R,,,SUBMITTED_CLAIM,RECEIVER_IDENTIFICATION_CODE,,
...
2000A.PRV02,Reference Identification Qualifier,Code qualifying the Reference Identification,R,PXC :  Health Care Provider Taxonomy Code,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_REFERENCE_IDENTIFIER,,
2000A.PRV03,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier",R,,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_TAXONOMY_CODE,,
...
2 : Non-Person Entity",,,,,
2010AA.NM103,Name Last or Organization Name,Individual last name or organizational name,S,,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_LAST_NAME,,
2010AA.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_FIRST_NAME,,
2010AA.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_MIDDLE_NAME,,
2010AA.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_NAME_SUFFIX,,
...
2010AA.NM109,Identification Code,Code identifying a party or other code / Billing Provider Identifier,S,,1477569838,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_IDENTIFIER,,
N3,Segment N3 - Billing Provider Address (Required),,R,,,,,,
2010AA.N301,Address Information,Address information,R,,777 BANNOCK ST,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_ADDRESS_1,,
2010AA.N302,Address Information,Address information,S,,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_ADDRESS_2,,
N4,"Segment N4 - Billing Provider City, State, ZIP Code (Required)",,R,,,,,,
2010AA.N401,City Name,Free-form text for city name,R,,DENVER,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_CITY,,
2010AA.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,CO,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_STATE_CODE,,
2010AA.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,802044507,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_POSTAL_CODE,,
2010AA.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_COUNTRY_CODE,,
...
SY : Social Security Number",,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,,,
2010AA.REF02,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier",R,,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,,,
...
2010AA.PER02,Name,Billing Provider Contact Name,S,,,SUBMITTED_CLAIM,"BILLING_PROVIDER_CONTACT_NAME
Contact name of the Billing Provider.",,
2010AA.PER03,Communication Number Qualifier,Code identifying the type of communication number,R,"""EM"" : Electronic Mail
""FX"" : Facsimile
""TE"" : Telephone",,,,,
2010AA.PER04,Communication Number,,R,,,SUBMITTED_CLAIM,BILLING_PROVIDER_CONTACT_NAME,,
2010AA.PER05,Communication Number Qualifier,Code identifying the type of communication numbe,S,"""EM"" : Electronic Mail
""FX"" : Facsimile
""TE"" : Telephone
""EX"" : Telephone Extension",,,,,
2010AA.PER06,Communication Number,Communication Number,S,,,SUBMITTED_CLAIM,BILLING_PROVIDER_CONTACT_NAME,,
...
2010AB.N301,Address Information,Address Information,R,,PO BOX 677931,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,,,
2010AB.N302,Address Information,Address Information,S,,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,,,
N4,"Segment - N4 Pay-To Address City, State, ZIP Code (Required)",,R,,,,,,
2010AB.N401,City Name,Free-form text for city name,R,,DALLAS,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,,,
2010AB.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,TX,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,,,
2010AB.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,752677931,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,,,
2010AB.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,,,
...
S : Secondary
T  : Tertiary",,,,,
2000B.SBR02,Individual Relationship Code,Code indicating the relationship between two individuals or entities,S,18 : Self,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_RELATIONSHIP_CODE,,
2000B.SBR03,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_POLICY_NUMBER,,
2000B.SBR04,Name,,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_GROUP_NAME,,
...
47 : Medicare Secondary, Other Liability Insurance",,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_INSURANCE_TYPE_CODE,,
...
ZZ Mutually Defined
71 Use Code ZZ when Type of Insurance is not known.",,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_FILING_INDICATOR,,
...
2000B.PAT06,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times / Patient Death Date",S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_DEATH_DATE,If Subscriber and patient are same 2000B PAT segment should be populated to 2000B PAT (SUBMITTED_CLAIM_PATIENT_DETAILS),
...
a measurement has been taken",S,01 : Actual Pounds,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_UNIT,,
2000B.PAT08,Weight,Numeric value of weight,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_WEIGHT,,
2000B.PAT09,Yes/No Condition or Response Code,Code indicating  whether the patient is pregnant or not pregnant.,S,Y :Yes,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_PREGNANCY_INDICATOR,,
...
2 : Non-Person Entity",,,,,
2010BA.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_LAST_NAME,Subscriber's full name concatenate NM103/5/4/7,
2010BA.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_FIRST_NAME,,
2010BA.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_MIDDLE_NAME,,
2010BA.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_NAME_SUFFIX,,
...
2010BA.NM109,Identification Code,Code identifying a party or other code / Subscriber Primary Identifier,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_IDENTIFICATION_CODE,,
N3,Segment - N3 Subscriber Address (Situational),,,,,,,,
2010BA.N301,Address Information,Address Information,R,,4600 W 9TH AVE UNIT 216,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_ADDRESS_1,,
2010BA.N302,Address Information,Address Information,S,,,,,,
N4,"Segment - N4 Subscriber City, State, ZIP Code (Situational)",,,,,,,,
2010BA.N401,City Name,Free-form text for city name,R,,DENVER,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_ADDRESS_CITY,,
2010BA.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,CO,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_ADDRESS_STATE,,
2010BA.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,802042991,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_ADDRESS_ZIP,,
2010BA.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_ADDRESS_COUNTRY,,
...
2010BA.DMG02,Date Time Period,Date Time Period,R,,19471120,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_BIRTH_DATE,,
2010BA.DMG03,Gender Code,Code indicating the sex of the individual,R,"F : Female
M : Male",,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_GENDER,"M=Male, F=Female, U=Unknown",
...
2010BA.PER04,Communication Number,,R,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_PHONE_NUMBER_1,,
2010BA.PER05,Communication Number Qualifier,Code identifying the type of communication number,S,EX :  Telephone Extension,,,,,
2010BA.PER06,Communication Number,,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_PHONE_NUMBER_2,,
...
2010BB.NM103,Name Last or Organization Name,,R,,,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_PAYER_NAME,,
...
2010BB.N404,Country Code,Code identifying the country,S,,,,,"Map to the value ""US"" if not present",
...
40:  Cadaver Donor
53:  Life Partner
G8 : Other Relationship",,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_SUBS_RELATIONSHIP,If Subscriber and patient are different 2000C PAT segment should be populated to 2000C PAT (SUBMITTED_CLAIM_PATIENT_DETAILS),
...
2000C.PAT06,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times / Patient Death Date",S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_DEATH_DATE,,
...
a measurement has been taken",S,01 : Actual Pounds,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_UNIT,,
2000C.PAT08,Weight,Numeric value of weight,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_WEIGHT,,
2000C.PAT09,Yes/No Condition or Response Code,Code indicating  whether the patient is pregnant or not pregnant.,S,Y :Yes,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_PREGNANCY_INDICATOR,,
...
2010CA.NM103,Name Last or Organization Name,Patient Last Name,R,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_LAST_NAME,,
2010CA.NM104,Name First,Patient First Name,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_FIRST_NAME,,
2010CA.NM105,Name Middle,Patient Middle Name or Initial,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_MIDDLE_NAME,,
2010CA.NM107,Name Suffix,Patient Name Suffix,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_NAME_SUFFIX,,
N3,Segment - N3 Patient Address (Situational),,,,,,,,
2010CA.N301,Address Information,Patient Address Line,R,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_ADDRESS_1,,
2010CA.N302,Address Information,Patient Address Line,S,,,,,,
N4,"Segment - N4 Patient City, State, ZIP Code (Situational)",,,,,,,,
2010CA.N401,City Name,Free-form text for city name,R,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_ADDRESS_CITY,,
2010CA.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_ADDRESS_STATE,,
2010CA.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_ADDRESS_ZIP,,
2010CA.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_ADDRESS_COUNTRY,,
...
2010CA.DMG02,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times/Patient Birth Date",R,,19670712,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_BIRTH_DATE,,
2010CA.DMG03,Gender Code,Code indicating the sex of the individual,R,"F: Female
M :Male
U : Unknown",,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_GENDER,,
...
applicable",R,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_PHONE_NUMBER_1,,
2010CA.PER05,Communication Number Qualifier,Code identifying the type of communication number,S,EX : Telephone Extension,,,,,
2010CA.PER06,Communication Number,Complete communications number including country or area code when applicable,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_PHONE_NUMBER_2,,
...
2300.CLM01,Claim Submitter's Identifier,Identifier used to track a claim from creation by the health care provider through payment,R,,,SUBMITTED_CLAIM,CLAIM_SUBMITTERS_IDENTIFIER,,
2300.CLM02,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM,CLAIM_AMOUNT,Map only when 2320.CAS  is present,
2300.CLM05.01,Facility Code Value,"Code identifying where services were, or may be, performed /Place of Service Code",R,,,SUBMITTED_CLAIM,CLAIM_FACILITY_CODE,,
...
2300.CLM05.03,Claim Frequency Type Code,Code specifying the frequency of the claim,R,,,SUBMITTED_CLAIM,CLAIM_FREQUENCY_TYPE,,
2300.CLM06,Yes/No Condition or Response Code,Provider or Supplier Signature Indicator,R,"Y : provider signature is on file
N : provider signature is not on file",,SUBMITTED_CLAIM,PROVIDER_SIGNATURE_IND,Map only when CLM06 value is 'Y',OPTION FIELD
...
C :  Not Assigned",,SUBMITTED_CLAIM,PROVIDER_ACCEPT_ASSIGNEMNT_CODE,"If 2300.CLM07 = “A”, Map “Y”
...
N : No
W :  Not Applicable",,SUBMITTED_CLAIM,BENEFIT_ASSIGNMENT_IND,,
...
Release of Medical Billing Data Related to a Claim",,SUBMITTED_CLAIM,RELEEASE_INFO_CODE,,
2300.CLM10,Patient Signature Source Code,"Code indicating how the patient or subscriber authorization signatures were
obtained and how they are being retained by the provider",S,P :  Signature generated by provider because the patient was not physically present for services,,SUBMITTED_CLAIM,,,
...
EM : Employment
OA : Other Accident",,SUBMITTED_CLAIM,,,
...
agency",S,,,SUBMITTED_CLAIM,,,
2300.CLM11.05,Country Code,Country Code,S,,,SUBMITTED_CLAIM,,,
...
2300.DTP03,Date Time Period,Date Time Period,R,,,SUBMITTED_CLAIM,,,
...
2300.DTP02,Date Time Period Format Qualifier,"Code indicating the date format, time format, or date and time format",R,D8 :  Date Expressed in Format CCYYMMDD,,,,,
2300.DTP03,Date Time Period,Date Time Period,R,,,SUBMITTED_CLAIM,TREATMENT_START_DT,,
...
2300.DTP02,Date Time Period Format Qualifier,"Code indicating the date format, time format, or date and time format",R,D8 : Date Expressed in Format CCYYMMDD,,,,,
2300.DTP03,Date Time Period,Date Time Period,R,,,SUBMITTED_CLAIM,ADMISSION_DATE,,
...
2300.DTP02,Date Time Period Format Qualifier,"Code indicating the date format, time format, or date and time format",R,D8 : Date Expressed in Format CCYYMMDD,,,,,
2300.DTP03,Date Time Period,Date Time Period,R,,,SUBMITTED_CLAIM,DISCHARGE_DATE,,
...
2300.DTP02,Date Time Period Format Qualifier,"Code indicating the date format, time format, or date and time format",R,D8 : Date Expressed in Format CCYYMMDD,,,,,
2300.DTP03,Date Time Period,Date Time Period,R,,,,,,
PWK,Segment - PWK Claim Supplemental Information (Situational),,,,,,,,
...
06 : Initial Assessment",,SUBMITTED_CLAIM,,,
...
EM : E-Mail
FT : File Transfer
FX : By Fax",,SUBMITTED_CLAIM,,,
2300.PWK05,Identification Code Qualifier,Code identifying a party or other code,S,AC:  Attachment Control Number,,,,,
2300.PWK06,Identification Code,Attachment Control Number. Used to identify the attached electronic documentation.The number in PWK06 is carried in the TRN of the electronic attachment,S,,,SUBMITTED_CLAIM,,,
...
2300.AMT01,Amount Qualifier Code,Code to qualify amount,R,F5 : Patient Amount Paid,,,PATIENT_AMT_CODE,,
2300.AMT02,Monetary Amount,Patient Amount Paid,R,,,SUBMITTED_CLAIM,PATIENT_AMOUNT_PAID,,
...
2300.REF02,Reference Identification,Referral Number,R,,,SUBMITTED_CLAIM,,,
...
2300.REF01,Reference Identification Qualifier,Code qualifying the Reference Identification,R,F8 : Original Reference Number,,,,Map only for void/replacement claims (2300.CLM05.03 = '7' or '8',
2300.REF02,Reference Identification,Payer Claim Control Number,R,,,SUBMITTED_CLAIM,HCC_CLAIM_NUMBER,Map only for void/replacement claims (2300.CLM05.03 = '7' or '8',
...
2300.REF02,Reference Identification,Value Added Network Trace Number,R,,,SUBMITTED_CLAIM,CLEARINGHOUSE_TRACE_NUMBER,,
...
DCP : Goals, Rehabilitation Potential, or Discharge Plans",,SUBMITTED_CLAIM,,,
2300.NTE02,Description,A free-form description to clarify the related data elements and their content  /  Claim Note Text,R,,,SUBMITTED_CLAIM,,,
...
trip.",S,,,,,,
2300.CR110,Description,Stretcher Purpose Description,S,,,SUBMITTED_CLAIM,"AMBULANCE_TRANSPORT_STRETCHER_PURPOSE
If the ambulance made a round trip, describes the purpose",,
...
CRC,Segment - CRC Ambulance Certification (Situational),A record is inserted into SUBMITTED_CLAIM_AMBULANCE_CERTIFICATION table for each repetition of CRC segment.,,,,,,,
...
N : No",,SUBMITTED_CLAIM_AMBULANCE_CERTIFICATION,"CONDITION_CODE_APPLIES_INDICATOR
...
12 : Patient is confined to a bed or chair",,SUBMITTED_CLAIM_AMBULANCE_CERTIFICATION,"CONDITION_CODE_APPLIES_INDICATOR
Ambulance condition code1",,
...
2300.HI01.02,Industry Code,Code indicating a code from a specific industry code list/Principal Diagnosis Code,R,,,SUBMITTED_CLAIM,DIAGNOSIS_CODE1,"If we get more than 3 digits, should add a dot (.)after 3rd Character",
2300.HI02.01,Code List Qualifier Code,Diagnosis Type Code,R,"ABF : ICD10 -CM -  Diagnosis
BF : ICD9 -CM -  Diagnosis",,,,,
2300.HI02.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM,DIAGNOSIS_CODE2,,
...
2300.HI01.02,Industry Code,Anesthesia Related Principal Surgical Procedure,R,,,SUBMITTED_CLAIM,ANESTHESIA_CODE,,
...
2300.HI02.02,Industry Code,Anesthesia Related  Surgical Procedure,R,,,SUBMITTED_CLAIM,,,
...
2300.HI01.02,Industry Code,Condition Code,R,,,SUBMITTED_CLAIM,,,
...
2310A.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,REFERRING_PROVIDER_LAST_NAME,,
2310A.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,REFERRING_PROVIDER_FIRST_NAME,,
2310A.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,REFERRING_PROVIDER_MIDDLE_NAME,,
2310A.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,REFERRING_PROVIDER_NAME_SUFFIX,,
...
National Provider Identifier",,,,,
2310A.NM109,Identification Code,Referring Provider Identifier,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,REFERRING_PROVIDER_IDENTIFICATION_CODE,,
...
G2 : Provider Commercial Number",,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
2310A.REF02,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier/ Referring Provider Secondary Identifier",R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
...
2 : Non-Person Entity",,,,,
2310B.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM,"Rendering_Provider_Last_Name
Submitted rendering provider last name.",if  Loop 2420A does not exist,
2310B.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM,"Rendering_Provider_First_Name
Submitted rendering provider first name.",if  Loop 2420A does not exist,
2310B.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM,"Rendering_Provider_Middle_Name
Submitted rendering provider middle name.",if  Loop 2420A does not exist,
2310B.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM,"Rendering_Provider_Name_Suffix
Submitted information rendering provider suffix.",if  Loop 2420A does not exist,
2310B.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code",S,"XX :  Centers for Medicare and Medicaid Services
National Provider Identifier",,,,,
2310B.NM109,Identification Code,Code identifying a party or other code /Rendering Provider Identifier,S,,,SUBMITTED_CLAIM,"Rendering_Provider_ID
Submitted Rendering Provider Id",if  Loop 2420A does not exist,
...
by the Reference Identification Qualifier / Provider Taxonomy Code",R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,if  Loop 2420A does not exist,
...
LU : Location Number",,SUBMITTED_CLAIM_PROVIDER_DETAILS,,if  Loop 2420A does not exist,
2310B.REF02,Reference Identification,Rendering Provider Secondary Identifier,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,if  Loop 2420A does not exist,
...
2310C.NM103,Name Last or Organization Name,Individual last name or organizational name /Laboratory or Facility Name,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,SERVICE_FACILITY_NAME,,
2310C.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code",S,"XX :  Centers for Medicare and Medicaid Services
National Provider Identifier",,,,,
2310C.NM109,Identification Code,Laboratory or Facility Primary Identifier,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,SERVICE_FACILITY_IDENTIFICATION_CODE,,
N3,Segment - N3 Service Facility Location Address (Required),,,,,,,,
2310C.N301,Address Information,Address information,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,SERVICE_FACILITY_ADDRESS_1,,
2310C.N302,Address Information,Address information,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,SERVICE_FACILITY_ADDRESS_2,second instance of street address,
N4,"Segment - N4 Service Facility Location City, State, ZIP Code (Required)",,,,,,,,
2310C.N401,City Name,Free-form text for city name,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,SERVICE_FACILITY_CITY_NAME,,
2310C.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,SERVICE_FACILITY_STATE_CODE,,
2310C.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,SERVICE_FACILITY_POSTAL_CODE,,
2310C.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,SERVICE_FACILITY_COUNTRY_CODE,,
...
by the Reference Identification Qualifier/Laboratory or Facility Secondary Identifier",R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
...
2310C.PER04,Communication Number,Complete communications number including country or area code when applicable,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
...
2310E.N301,Address Information,Ambulance Pick-up Address Line,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
2310E.N302,Address Information,Ambulance Pick-up Address Line,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
N4,"Segment - N4 Ambulance Pick-up Location City, State, ZIP Code (Required)",,,,,,,,
2310E.N401,City Name,Free-form text for city name,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
2310E.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
2310E.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
,,,,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
2310E.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
...
2310F.NM103,Name Last or Organization Name,Ambulance Drop-off Location,S,,,SUBMITTED_CLAIM,"AMBULANCE_DROPOFF_LOCATION_NAME
Location name for Drop off",,
N3,Segment - N3 Ambulance Drop-off Location Address (Required),,,,,,,,
2310F.N301,Address Information,Ambulance Drop-off Address Line,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
2310F.N302,Address Information,Ambulance Drop-off Address Line,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
N4,"Segment - N4 Ambulance Drop-off Location City, State, ZIP Code (Required)",,,,,,,,
2310F.N401,City Name,Free-form text for city name,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
2310F.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
2310F.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
2310F.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,,,
2310F.N407,Country Subdivision Code,Code identifying the country subdivision,,,,,,,
Loop 2320 — OTHER SUBSCRIBER INFORMATION(Situational) Loop Repeat: 10                                        A record is inserted into SUBMITTED_CLAIM_OTHER_SUBSCRIBER  table for each repetition of 2320 loop.,,,S,,,,,,
...
claim",R,"P : Primary
S : Secondary
T : Tertiary",,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,,,Not taking this as part of the PSD requirement
...
40 Cadaver Donor
53 Life Partner
G8 Other Relationship",,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,"Relationship_To_Insured
Relationship to insured subscriber",,
2320.SBR03,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier/Insured Group or Policy Number",S,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,,,
2320.SBR04,Name,Other Insured Group Name,S,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,,,
2320.SBR05,Insurance Type Code,Code identifying the type of insurance policy within a specific insurance program,S,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,,,
2320.SBR09,Claim Filing Indicator Code,Code identifying type of claim,S,,"MB :Medicare Part B
MA: Medicare Part A
MC: Medicaid",SUBMITTED_CLAIM_OTHER_SUBSCRIBER,,,
...
PR : Patient Responsibility",,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE,,
2320.CAS02,Claim Adjustment Reason Code,Code identifying the detailed reason the adjustment was made,R,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_REASON_CODE_1,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS03,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_AMT_1,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS04,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_QTY_1,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS05,Claim Adjustment Reason Code,Code identifying the detailed reason the adjustment was made,R,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_REASON_CODE_2,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS06,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_AMT_2,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS07,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_QTY_2,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS08,Claim Adjustment Reason Code,Code identifying the detailed reason the adjustment was made,R,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_REASON_CODE_3,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS09,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_AMT_3,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS10,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_QTY_3,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS11,Claim Adjustment Reason Code,Code identifying the detailed reason the adjustment was made,R,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_REASON_CODE_4,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS12,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_AMT_4,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS13,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_QTY_4,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS14,Claim Adjustment Reason Code,Code identifying the detailed reason the adjustment was made,R,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_REASON_CODE_5,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS15,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_AMT_5,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS16,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_QTY_5,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS17,Claim Adjustment Reason Code,Code identifying the detailed reason the adjustment was made,R,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_REASON_CODE_6,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS18,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_AMT_6,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2320.CAS19,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,CLAIM_ADJUSTMENT_GROUP_CODE.CLAIM_ADJUSTMENT_QTY_6,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
...
2320.AMT02,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,PAYER_AMOUNT_PAID,,
...
2320.AMT02,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,,,
...
2320.AMT02,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,NONCOVERED_CHARGES,,
...
benefits.
Y :  Yes",,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,"BENEFITS_ASSIGNMENT_CERTIFICATION_INDICATOR
...
Y : Yes, Provider has a Signed Statement Permitting
Release of Medical Billing Data Related to a Claim",,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,"INFORMATION_RELEASE_CERTIFICATION_INDICATOR
Information release certification indicator",,
MOA,Segment - MOA Outpatient Adjudication Information (Situational),A record is inserted into SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO  table for each repetition of MOA segment.,,,,,,,
2320.MOA01,Percentage as Decimal,"Percentage expressed as a decimal (e.g., 0.0 through 1.0 represents 0% through
100%)",S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO,"REIMBURSEMENT_RATE
Reimbulsement rate",,
2320.MOA02,Monetary Amount,Monetary amount,S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO,"HCPCS_PAYABLE_AMOUNT
...
by the Reference Identification Qualifier /  Claim Payment Remark Code",S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO,"CLAIM_PAYMENT_REMARK_CODE_1
...
by the Reference Identification Qualifier /  Claim Payment Remark Code",S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO,"CLAIM_PAYMENT_REMARK_CODE_2
...
by the Reference Identification Qualifier /  Claim Payment Remark Code",S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO,"CLAIM_PAYMENT_REMARK_CODE_3
...
by the Reference Identification Qualifier /  Claim Payment Remark Code",S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO,"CLAIM_PAYMENT_REMARK_CODE_4
...
by the Reference Identification Qualifier /  Claim Payment Remark Code",S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO,"CLAIM_PAYMENT_REMARK_CODE_5
Claim payment remark code 5",,
2320.MOA08,Monetary Amount,Monetary Amount/End Stage Renal Disease Payment Amount,S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO,"ESRD_PAYMENT_AMOUNT
ESRD payment amount",,
2320.MOA09,Monetary Amount,"Monetary Amount/ Non-Payable Professional Component Billed
Amount",S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO,NON_PAYABLE_PROF_COMP_BILLED_AMOUNT,,
...
2 : Non-Person Entity",,,,,
2330A.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_LAST_NAME,,
2330A.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_FIRST_NAME,,
2330A.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_MIDDLE_NAME,,
2330A.NM107,Name Suffix,Suffix to individual name,S,E,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_NAME_SUFFIX,,
...
MI :Member Identification Number",,,,,
2330A.NM109,Identification Code,Code identifying a party or other code,R,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_INDENTIFICATION_CODE,,
N3,Segment - N3 Other Subscriber Address (Situational),,,,,,,,
2330A.N301,Address Information,Address Information,R,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,"OTHER_INSURED_ADDRESS_LINE_1
Other Insured Subscriber Address Line1",,
2330A.N302,Address Information,Address Information,S,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,"OTHER_INSURED_ADDRESS_LINE_2
Other Insured Subscriber Address Line2",,
N4,Segment - N4 Other Subscriber City/State/ZIP Code (Situational),,,,,,,,
2330A.N401,City Name,Free-form text for city name,R,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,"OTHER_INSURED_CITY
Other Insured Subscriber City",,
2330A.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,"OTHER_INSURED_STATE
Other Insured Subscriber State",,
2330A.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,"OTHER_INSURED_ZIP
Other Insured Subscriber Zip",,
...
by the Reference Identification Qualifier / Other Insured Additional Identifier",R,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,"OTHER_INSURED_ADDITIONAL_IDENTIFIER
Other insured additional identifier",,
Loop 2330B — OTHER PAYER NAME (Situational) Loop Repeat: 1   A record is inserted into  SUBMITTED_CLAIM_OTHER_PAYER  table for each 2330B loop.,,,,,,,,,
...
2330B.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_OTHER_PAYER_NAME,,
...
XV : Centers for Medicare and Medicaid Services PlanID",,,,,
2330B.NM109,Identification Code,Code identifying a party or other code,R,,,SUBMITTED_CLAIM_OTHER_PAYER,"OTHER_PAYER_PRIMARY_IDENTIFIER
Other payor primary identifier",,
N3,Segment - N3 Other Payer Address (Situational),,,,,,,,
2330B.N301,Address Information,Address Information,R,,,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_OTHER_PAYER_ADD_1,,
2330B.N302,Address Information,Address Information,S,,,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_OTHER_PAYER_ADD_2,,
N4,Segment - N4 Other Payer City/State/ZIP Code (Situational),,,,,,,,
2330B.N401,City Name,Free-form text for city name,R,,,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_OTHER_PAYER_CITY,,
2330B.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_OTHER_PAYER_STATE,,
2330B.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_OTHER_PAYER_ZIP,,
2330B.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_OTHER_PAYER_COUNTRY,,
...
2330B.DTP03,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,20210305,SUBMITTED_CLAIM_OTHER_PAYER,Adjuntication or payment date,,
...
2330B.REF02,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier/ : Other Payer’s Claim Control Number",R,,,SUBMITTED_CLAIM_OTHER_PAYER,,,
...
Loop 2400  — SERVICE LINE NUMBER(Required) Loop Repeat: 50                    A record is inserted into SUBMITTED_CLAIM_LINE  table for each occurrence of 2400 Loop.,,,,,,,,,
LX,Segment - LX Service Line Number (Required),,,,,,,,
2400.LX01,Assigned Number,Number assigned for differentiation within a transaction set,R,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,"SUBMITTED_LINE_NUMBER
Submitted Claim Line number",,
,,,,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,"SUBMITTED_LINE_NUMBER
Submitted line number",,
...
2400.SV101.02,Product/Service ID,identifying number for a product or service,R,,90837,SUBMITTED_CLAIM_LINE,SERVICE_CODE,,
2400.SV101.03,Procedure Modifier,"This identifies special circumstances related to the performance of the service, as defined by trading partners",S,,HE,SUBMITTED_CLAIM_LINE,PROCEDURE_MOD_1,,
2400.SV101.04,Procedure Modifier,"This identifies special circumstances related to the performance of the service, as defined by trading partners",S,,GT,SUBMITTED_CLAIM_LINE,PROCEDURE_MOD_2,,
2400.SV101.05,Procedure Modifier,"This identifies special circumstances related to the performance of the service, as defined by trading partners",S,,GT,SUBMITTED_CLAIM_LINE,PROCEDURE_MOD_3,,
2400.SV101.06,Procedure Modifier,"This identifies special circumstances related to the performance of the service, as defined by trading partners",S,,GT,SUBMITTED_CLAIM_LINE,PROCEDURE_MOD_4,,
2400.SV101.07,Description,A free-form description to clarify the related data elements and their content,S,,,SUBMITTED_CLAIM_LINE,,,
2400.SV102,Monetary Amount,Monetary Amount,R,,233.19,SUBMITTED_CLAIM_LINE,LINE_ITEM_AMOUNT,,CHECK WITH AMBILY
...
MJ : Minutes",,SUBMITTED_CLAIM_LINE,LINE_ITEM_UNITS,,
2400.SV104,Quantity,Numeric value of quantity,R,,,SUBMITTED_CLAIM_LINE,LINE_ITEM_QUANTITY,,
,,,,,,SUBMITTED_CLAIM_LINE,,,
2400.SV105,Facility Code Value,"Code identifying where services were, or may be, performed; the first and second positions of the Uniform Bill Type Code for Institutional Services or the Place of Service Codes for Professional or Dental Services.",S,,,SUBMITTED_CLAIM_LINE,,,
2400.SV107.01,Diagnosis Code Pointer,A pointer to the diagnosis code in the order of importance to this service,R,,,SUBMITTED_CLAIM_LINE,,,
2400.SV107.02,Diagnosis Code Pointer,A pointer to the diagnosis code in the order of importance to this service,S,,,SUBMITTED_CLAIM_LINE,,,
2400.SV107.03,Diagnosis Code Pointer,A pointer to the diagnosis code in the order of importance to this service,S,,,SUBMITTED_CLAIM_LINE,,,
2400.SV107.04,Diagnosis Code Pointer,A pointer to the diagnosis code in the order of importance to this service,S,,,SUBMITTED_CLAIM_LINE,,,
2400.SV109,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response /Emergency Indicator,S,Y :Yes,,SUBMITTED_CLAIM_LINE,,,
2400.SV111,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response /EPSDT Indicator,S,Y :Yes,,SUBMITTED_CLAIM_LINE,,,
...
2400.CR102,Weight,Numeric value of weight,S,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,PATIENT_WEIGHT,,
...
C : Patient was transported for the nearness of family members
D : Patient was transported for the care of a specialist
E : Patient Transferred to Rehabilitation Facility",,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_REASON_CODE,,
2400.CR105,Unit or Basis for Measurement Code,"Code specifying the units in which a value is being expressed, or manner in which a measurement has been taken",R,DH : Miles,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_UNITS,,
2400.CR106,Quantity,Transport Distance,R,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_TRANSPORT_DISTANCE,,
2400.CR109,Description,"Round Trip Purpose Description. Required when the ambulance service is for a round
trip.",S,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_PURPOSE_DESC,,
...
N : No",,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,"CONDITION_CODE_APPLIES_INDICATOR
Ambulance condition code",,
...
08 : Patient had visible hemorrhaging
09 : Ambulance service was medically necessary
12 : Patient is confined to a bed or chair",,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,"CONDITION_CODE_APPLIES_INDICATOR
Ambulance condition code1",,
...
2400.DTP03,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,20201112,SUBMITTED_CLAIM_LINE,LINE_SERVICE_DT,"01-08 -If we receive date format  CCYYMMDD We need to map both start date and end date


byte 1-8 in the format YYYY-MM-DD",
,,,,,,SUBMITTED_CLAIM_LINE,,byte 10-17 in the format YYYY-MM-DD,
...
2400.QTY02,Quantity,Numeric value of quantity,R,,,SUBMITTED_CLAIM_LINE,AMBULANCE_PATIENT_COUNT,,
...
DCP: Goals, Rehabilitation Potential, or Discharge Plans",,SUBMITTED_CLAIM_LINE,,,
2400.NTE02,Description,A free-form description to clarify the related data elements and their content,R,,,SUBMITTED_CLAIM_LINE,,,
NTE,Segment - NTE Third Party Organization Notes (Situational),,,,,,,,
2400.NTE01,Note Reference Code,Code identifying the functional area or purpose for which the note applies,R,TPO : Third Party Organization Notes,,SUBMITTED_CLAIM_LINE,,,
2400.NTE02,Description,A free-form description to clarify the related data elements and their content,R,,,SUBMITTED_CLAIM_LINE,,,
...
Product/Service ID",R,N4 : National Drug Code in 5-4-2 Format,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,DRUG_CODE,Map N4 as 'ND',
2410.LIN03,Product/Service ID,Identifying number for a product or service,R,,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,DRUG_PRODUCT_ID,,
CTP,Segment - CTP Drug Quantity (Required),,,,,,,,
2410.CTP04,Quantity,Numeric value of quantity,R,,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,DRUG_QUANTITY,,
...
ME :Milligram
ML :Milliliter
UN :Unit",,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,DRUG_QUANTITY_MEASURE,,
...
2 : Non-Person Entity",,,,,
2420A.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_LINE,Last Name of Rendering Provider,,
2420A.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_LINE,First Name of Rendering Provider,,
2420A.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_LINE,Middle Name of Rendering Provider,,
2420A.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_LINE,Name Suffix of Rendering Provider,,
...
National Provider Identifier",,,,,
2420A.NM109,Identification Code,Code identifying a party or other code /: Rendering Provider Identifier,S,1000959250,,SUBMITTED_CLAIM_LINE,Unique Identifier for a rendering Provider,,
PRV,Segment - PRV Rendering Provider Specialty Information (Situational),,,,,,,,
...
2420A.PRV03,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,R,,1041C0700X,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
REF,Segment - REF Rendering Provider Secondary Identification (Situational),,,,,,,,
2420A.REF01,Reference Identification Qualifier,Code qualifying the Reference Identification,R,"0B: State License Number
1G : Provider UPIN Number
G2 : Provider Commercial Number
LU : Location Number",,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
2420A.REF02,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier",R,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
...
2420C.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
...
2420D.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
2420D.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
2420D.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
2420D.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
...
National Provider Identifier",,,,,
2420D.NM109,Identification Code,Code identifying a party or other code,S,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
REF,Segment - REF Supervising Provider Secondary Identification (Situational),,,,,,,,
...
2420E.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
2420E.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
2420E.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
2420E.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
2420E.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code (67)",S,"XX :  Centers for Medicare and Medicaid Services
National Provider Identifier",,,,,
2420E.NM109,Identification Code,Code identifying a party or other code,S,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
N3,Segment - N3 Ordering Provider Address (Situational),,,,,,,,
2420E.N301,Address Information,Address Information,R,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
2420E.N302,Address Information,Address Information,S,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
N4,"Segment - N4 Ordering Provider City, State, ZIP Code (Situational)",,,,,,,,
2420E.N401,City Name,Free-form text for city name,R,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
2420E.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,byte 1-5,
2420E.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,byte 6-9,
2420E.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,"Map to the value ""US"" if not present",
...
1G : Provider UPIN Number
G2 : Provider Commercial Number",,SUBMITTED_CLAIM_CLAIMLINE_PROVIDER,,,
...
2420F.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_LINE,"REFERRING_PROVIDER_LAST_NAME
Last Name of Referring Provider",If  2420F.NM101  = DN,
2420F.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_LINE,"REFERRING_PROVIDER_FIRST_NAME
First Name of Referring Provider",If  2420F.NM101  = DN,
2420F.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_LINE,"REFERRING_PROVIDER_MIDDLE_NAME
Middle Name of Referring Provider",If  2420F.NM101  = DN,
2420F.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_LINE,"REFERRING_PROVIDER_NAME_SUFFIX
Name Suffix of Referring Provider",If  2420F.NM101  = DN,
2420F.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code (67)",S,"XX :  Centers for Medicare and Medicaid Services
National Provider Identifier",,,,,
2420F.NM109,Identification Code,Code identifying a party or other code,S,,,SUBMITTED_CLAIM_LINE,"REFERRING_PROVIDER_IDENTIFIER
Unique Identifier for a refering Provider",If  2420F.NM101  = DN,
REF,Segment - REF Referring Provider Secondary Identification (Situational),,,,,,,,
...
N3,Segment- N3 Ambulance Pick-up Location Address (Required),,,,,,,,
2420G.N301,Address Information,Address Information,R,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_PICKUP_ADD_1,,
2420G.N302,Address Information,Address Information,S,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_PICKUP_ADD_2,,
N4,"Segment - N4 Ambulance Pick-up Location City, State, ZIP Code (Required)",,,,,,,,
2420G.N401,City Name,Free-form text for city name,R,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_PICKUP_ADD_CITY,,
2420G.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_PICKUP_ADD_STATE,,
2420G.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_PICKUP_ADD_ZIP,,
2420G.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_PICKUP_ADD_COUNTRY,"Map to the value ""US"" if not present",
...
2420H.NM103,Name Last or Organization Name,Individual last name or organizational name,S,,,SUBMITTED_CLAIM_LINE,AMBULANCE_DROPOFF_LOCATION_NAME,,
N3,Segment - N3 Ambulance Drop-off Location Address (Required),,,,,,,,
2420H.N301,Address Information,Address Information,R,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_DROPOFF_ADD_1,,
2420H.N302,Address Information,Address Information,S,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_DROPOFF_ADD_2,,
N4,"Segment - N4 Ambulance Drop-off Location City, State, ZIP Code (Required)",,,,,,,,
2420H.N401,City Name,Free-form text for city name,R,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_DROPOFF_ADD_CITY,,
2420H.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_DROPOFF_ADD_STATE,,
2420H.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_DROPOFF_ADD_ZIP,,
2420H.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM_LINE_AMBULANCE_CERTIFICATION,AMB_DROPOFF_ADD_COUNTRY,"Map to the value ""US"" if not present",
...
2430.SVD02,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,SERVICE_LINE_PAID_AMOUNT,,
,,,,,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,SERVICE_LINE_ALLOWED_AMOUNT,Sum netpaid amount (2430.SVD02) and CAS*PR amounts for the payer in line level - 2430 loop and map to this field,
...
OA : Other adjustments
PI : Payor Initiated Reductions
PR : Patient Responsibility",,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE,,
2430.CAS02,Claim Adjustment Reason Code,Code identifying the detailed reason the adjustment was made,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_REASON_CODE_1,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS03,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_AMT_1,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS04,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_QTY_1,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS05,Claim Adjustment Reason Code,Code identifying the detailed reason the adjustment was made,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_REASON_CODE_2,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS06,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_AMT_2,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS07,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_QTY_2,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS08,Claim Adjustment Reason Code,Code identifying the detailed reason the adjustment was made,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_REASON_CODE_3,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS09,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_AMT_3,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS10,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_QTY_3,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS11,Claim Adjustment Reason Code,Code identifying the detailed reason the adjustment was made,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_REASON_CODE_4,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS12,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_AMT_4,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS13,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_QTY_4,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS14,Claim Adjustment Reason Code,Code identifying the detailed reason the adjustment was made,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_REASON_CODE_5,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS15,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_AMT_5,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS16,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_QTY_5,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS17,Claim Adjustment Reason Code,Code identifying the detailed reason the adjustment was made,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_REASON_CODE_6,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS18,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_AMT_6,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
2430.CAS19,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,CLAIM_LINE_ADJUSTMENT_GROUP_CODE.CLAIM_LINE_ADJUSTMENT_QTY_6,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
...
2430.DTP03,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,20210526,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,CLAIM_LINE_REMITTENCE_DATE,"In the format YYYY-MM-DD
...
2430.AMT02,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,,,
...
## Repository/Claims/V26.1.1.0/EdifecsProduct_MappingSpec_ClaimsRepo_837IP_EDI_to_DFFConversion_V2.1.xlsx — 837I

```csv
EDI LoopID.Segment,EDI Data Element Name,EDI Element Description,Usage,Enumeration Values,Sample values,"Mapped to
Integration PlusTable Name",Column Name,Column Desc,Comments
ISA - Interchange Control Header Segment,,,,,,,,,
ISA01,Authorization Information Qualifier,Code identifying the type of information in the Authorization Information,R,00 : No Authorization Information Present,,,,,
...
ISA03,Security Information Qualifier,Code identifying the type of information in the Security Information,R,0,,,,,
ISA04,Security Information,"security information about the interchange sender
or the data in the interchange",R,Blank (10 spaces),,,,,
ISA05,Interchange ID Qualifier,"Code indicating the system/method of code structure used to designate the
sender or receiver ID element being qualified",R,ZZ - Mutually Defined,,,,,
...
element",R,<Sender ID>,Example: 100SS,,,,
ISA07,Interchange ID Qualifier,"Code indicating the system/method of code structure used to designate the
...
ISA12,Interchange Control Version Number,Code specifying the version number of the interchange control segments,R,501,,,,,
...
ST01,Transaction Set Identifier Code,Code uniquely identifying a Transaction Set,R,837 : Health Care Claim,,,,,
ST02,Transaction Set Control Number,Unique Sequential Number Assigned by Internal Processes for each Transaction Set. Starts from 001 and increments with each transaction set,R,"<Transaction set Control Number>
Starts from 001 and increments with each transaction set",2,,,,
...
BHT04,Date,The date the transaction was created,R,SysDate (YYYYMMDD) -,,SUBMITTED_CLAIM,CLAIM_CREATION_DATE,,
BHT05,Time,The time the transaction was created,R,SysTime (HHMMSS),121314,SUBMITTED_CLAIM,CLAIM_CREATION_TIME,,
BHT06,Transaction Type Code,Code specifying the type of transaction,R,CH- Chargeable,,,,,
...
1000A.NM102,Entity Type Qualifier,Code qualifying the type of entity,R,"1 : Person
2 : Non-person Entity",,,,,
1000A.NM103,Name Last or Organization Name,Individual last name or organizational name,R,<Submitter Last/Org Name>,THE SSI GROUP,SUBMITTED_CLAIM,SUBMITTER_NAME,,
1000A.NM104,Name First,Individual first name,S,,,,,,
1000A.NM105,Name Middle,Individual middle name or initial,S,,,,,,
1000A.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code",R,46 : Electronic Transmitter Identification Number (ETIN,,,,,
1000A.NM109,Identification Code,Code identifying a party or other code,R,<Submitter ID>,100SS,SUBMITTED_CLAIM,SUBMITTER_IDENTIFICATION_CODE,,
...
2 : Non-person Entity",,,,,
1000B.NM103,Name Last or Organization Name,Code identifying an organizational NAME,R,,HealthPlan Name,SUBMITTED_CLAIM,RECEIVER_NAME,,
1000B.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code",R,46 : Electronic Transmitter Identification Number (ETIN,,,,,
1000B.NM109,Identification Code,Code identifying a party,R,,<HealthPlan Payer ID>,SUBMITTED_CLAIM,RECEIVER_IDENTIFICATION_CODE,,
...
2010AA.NM102,Entity Type Qualifier,Code qualifying the type of entity,R,"1 : Person
2 : Non-Person Entity",,,,,
2010AA.NM103,Name Last or Organization Name,Individual last name or organizational name,R,<Billing Provider Organizational Name>,MILLCREEK OF ARKANSAS,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_LAST_NAME,,
2010AA.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code (67)",S,"XX :  Centers for Medicare and Medicaid Services
National Provider Identifier",,,,,
2010AA.NM109,Identification Code,Code identifying a party or other code / Billing Provider Identifier,S,<Billing Provider NPI> -,52482036,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_IDENTIFIER,,
Segment N3 - Billing Provider Address (Required),,,,,,,,,
2010AA.N301,Address Information,Code identifying the address,R,<Billing Provider Address Line>,4495 YUKON COURT APT 78,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_ADDRESS_1,,
2010AA.N302,Address Information,Code identifying the address,S,<Billing Provider Address Line>,PO BOX 17471,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_ADDRESS_2,,
"Segment N4 - Billing Provider City, State, ZIP Code (Required)",,,,,,,,,
2010AA.N401,City Name,Code identifying the address,R,,DENVER,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_CITY,,
2010AA.N402,State or Province Code,Code identifying the address,S,,CO,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_STATE_CODE,,
2010AA.N403,Postal Code,Code identifying the address,S,,802044507,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_POSTAL_CODE,,
2010AA.N404,Country Code,Code identifying the address,S,,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_COUNTRY_CODE,,
2010AA.N407,Country Subdivision Code,,S,,,,,,
Segment REF - Billing Provider Tax Identification (Required),,,,,,,,,
2010AA.REF01,Reference Identification Qualifier,Code qualifying the Reference Identification,R,"EI : Employer’s Identification Number
SY : Social Security Number",,,,,
2010AA.REF02,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier",R,,,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_TAX_IDENTIFICATION_NUMBER,,
Segment - PER Billing Provider Contact Information (Situational),,,,,,,,,
2010AA.PER01,Contact Function Code,Code identifying the major duty or responsibility of the person or group name,R,IC -  Information Contact,,,,,
2010AA.PER02,Name,Billing Provider Contact Name,S,,,SUBMITTED_CLAIM,BILLING_PROVIDER_CONTACT_NAME,Contact name of the Billing Provider.,
2010AA.PER03,Communication Number Qualifier,Code identifying the type of communication number,R,"""EM"" : Electronic Mail
""FX"" : Facsimile
""TE"" : Telephone","FX- Facsimile
TE - Telephone",,,,
2010AA.PER04,Communication Number,"Complete communications number including
country or area code",R,,3033981735,SUBMITTED_CLAIM_BILLINGPROVIDER_DETAILS,BILLING_PROVIDER_CONTACT_INFO,Contact Info of the Billing Provider.,
2010AA.PER05,Communication Number Qualifier,Code identifying the type of communication numbe,S,"""EM"" : Electronic Mail
""FX"" : Facsimile
""TE"" : Telephone
...
2010AB.N301,Address Information,Address Information,R,,PO BOX 17379,SUBMITTED_CLAIM,PAY_TO_ADDRESS_1,,
2010AB.N302,Address Information,Address Information,S,,,SUBMITTED_CLAIM,PAY_TO_ADDRESS_2,,
"Segment - N4 Pay-To Address City, State, ZIP Code (Required)",,,,,,,,,
2010AB.N401,City Name,Free-form text for city name,R,,DENVER,SUBMITTED_CLAIM,PAY_TO_ADDRESS_CITY,,
2010AB.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,CO,SUBMITTED_CLAIM,PAY_TO_ADDRESS_STATE_NAME,,
2010AB.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,802170379,SUBMITTED_CLAIM,PAY_TO_ADDRESS_POSTAL_CODE,,
2010AB.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM,PAY_TO_ADDRESS_COUNTRY_CODE,,
2010AB.N407,Country Subdivision Code,Code identifying the country subdivision,S,,,,,,
...
40 Cadaver Donor
53 Life Partner
G8 Other Relationship",,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_RELATIONSHIP_CODE,,
2000B.SBR03,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_POLICY_NUMBER,,
2000B.SBR04,Name,,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_GROUP_NAME,,
...
2010BA.NM102,Entity Type Qualifier,Code qualifying the type of entity,R,"1 : Person
2 : Non-Person Entity",,,,,
2010BA.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_LAST_NAME,,
2010BA.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_FIRST_NAME,,
2010BA.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_MIDDLE_NAME,,
2010BA.NM107,Name Suffix,Suffix,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_NAME_SUFFIX,,
2010BA.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code",S,"II :  Standard Unique Health Identifier for each Individual in the United States
MI  :  Member Identification Number",,,,,
2010BA.NM109,Identification Code,Code identifying a party or other code / Subscriber Primary Identifier,S,,561005,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_IDENTIFICATION_CODE,,
Segment - N3 Subscriber Address (Situational),,,,,,,,,
2010BA.N301,Address Information,Address Information,R,,4495 YUKON COURT APT 78,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_ADDRESS_1,,
2010BA.N302,Address Information,,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_ADDRESS_2,,
"Segment - N4 Subscriber City, State, ZIP Code (Situational)",,,,,,,,,
2010BA.N401,City Name,Free-form text for city name,R,,WHEAT RIDGE,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_ADDRESS_CITY,,
2010BA.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,CO,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_ADDRESS_STATE,,
2010BA.N403,Postal Code,Code defining international postal zone code excluding punctuation and blanks (zip code for United States),S,,800333283,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_ADDRESS_ZIP,,
2010BA.N404,Country Code,Code identifying the country,S,,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_ADDRESS_COUNTRY,,
2010BA.N407,Country Subdivision Code,Code identifying the country subdivision,S,,,,,,
...
2010BA.DMG02,Date Time Period,Date Time Period,R,YYYYMMDD,,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_BIRTH_DATE,,
2010BA.DMG03,Gender Code,Code indicating the sex of the individual,R,"F : Female
M : Male",,SUBMITTED_CLAIM_SUBSCRIBER_DETAILS,SUBSCRIBER_GENDER,,
...
individual",R,PR -Payer,,,,,
2010BB.NM102,Entity Type Qualifier,Code qualifying the type of entity,R,2 :Non-Person Entity,,,,,
2010BB.NM103,Name Last or Organization Name,Name Last or Organization Name,R,HealthPlan,,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_PAYER_NAME,,
2010BB.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code",R,"PI :  Payor Identification
XV : Centers for Medicare and Medicaid Services PlanID",,,,,
2010BB.NM109,Identification Code,Code identifying a party or other code / Subscriber Primary Identifier,R,,COACC,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_PAYER_IDENTIFICATION_CODE,,
...
individual",R,QC : Patient,,,,,
2010CA.NM102,Entity Type Qualifier,Code qualifying the type of entity,R,1: Person,,,,,
2010CA.NM103,Name Last or Organization Name,Organization Name Last Name,R,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_LAST_NAME,,
2010CA.NM104,Name First,Patient  First Name,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_FIRST_NAME,,
2010CA.NM105,Name Middle,Patient Middle Name or Initial,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_MIDDLE_NAME,,
2010CA.NM107,Name Suffix,Patient Name Suffix,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_NAME_SUFFIX,,
Segment - N3 Patient Address (Situational),,,,,,,,,
2010CA.N301,Address Information,Code identifying the Patient address,R,,1000 JACKSON ST,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_ADDRESS_1,,
2010CA.N302,Address Information,Code identifying the Patient address,S,,,SUBMITTED_CLAIM_PATIENT_DETAILS,PATIENT_ADDRESS_2,,
...
2300.CLM01,Claim Submitter's Identifier,Identifier used to track a claim from creation by the health care provider through payment,R,,<patientControlNumber> 1003795048I7791539,SUBMITTED_CLAIM,CLAIM_SUBMITTERS_IDENTIFIER,,
2300.CLM02,Monetary Amount,"Monetary Amount   CLM02 is the total amount of all submitted charges of service segments
for this claim.",R,,214.25,SUBMITTED_CLAIM,CLAIM_AMOUNT,,
...
Services.",R,,,SUBMITTED_CLAIM,CLAIM_FACILITY_CODE,,
...
the Uniform Billing Claim Form Bill Type",R,1,,SUBMITTED_CLAIM,CLAIM_FREQUENCY_TYPE,,
2300.CLM07,Provider Accept Assignment Code,Code indicating whether the provider accepts assignment,R,"A : Assigned
B : Assignment Accepted on Clinical Lab Services Only
C :  Not Assigned",,SUBMITTED_CLAIM,PROVIDER_ACCEPT_ASSIGNEMNT_CODE,,
2300.CLM08,Yes/No Condition or Response Code,Benefits Assignment Certification Indicator,R,"Y : Yes
N : No
W :  Not Applicable",,SUBMITTED_CLAIM,BENEFIT_ASSIGNMENT_IND,,
2300.CLM09,Release of Information Code,"Code indicating whether the provider has on file a signed statement by the patient
...
CCYYMMDDHHMM",,,,,
2300.DTP03,Date Time Period,Date Time Period,R,HH:MM,,SUBMITTED_CLAIM,DISCHARGE_DATE,,
...
2300.DTP03,Date Time Period,Date Time Period,R,,20210311-20210311,SUBMITTED_CLAIM,STATEMENT_DATE,,
Segment - DTP Admission Date/Hour (Situational),,,,,,,,,
2300.DTP01,Date/Time Qualifier,"Code specifying type of date or time, or both date and time",R,435 :Admission,,,,,
2300.DTP02,Date Time Period Format Qualifier,"Code indicating the date format, time format, or date and time format",R,D8 :  Date Expressed in Format CCYYMMDD,,,,,
2300.DTP03,Date Time Period,Date Time Period,R,"If D8 - CCYYMMDD
If DT- CCYYMMDDHH",,SUBMITTED_CLAIM,ADMISSION_DATE,,
...
2-Urgent
3-Elective",,SUBMITTED_CLAIM,ADMISSION_TYPE_CODE,,
2300.CL102,Admission Source Code,Code indicating the source of this admissio,S,,,SUBMITTED_CLAIM,ADMISSION_SOURCE_CODE,,
2300.CL103,Patient Status Code,Code indicating patient status as of the “statement covers through date,R,,,SUBMITTED_CLAIM,PATIENT_STATUS_CODE,,
...
Code (67)",S,,,,,,
2300.PWK06,Identification Code,Code identifying a party or other code,S,,,,,,
...
05 Capitated
06 Percent
09 Other",,SUBMITTED_CLAIM,CONTRACT_TYPE_CODE,,
2300.CN102,Monetary Amount,Monetary amount,S,,,SUBMITTED_CLAIM,CONTRACT_AMOUNT,,
2300.CN103,"Percent, Decimal Format","Percent given in decimal format (e.g., 0.0 through 100.0 represents 0% through
100%)",S,,,SUBMITTED_CLAIM,CONTRACT_PERCENTAGE,,
...
2300.AMT02,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM,PATIENT_ESTIMATED_AMOUNT_DUE,,
...
2300.REF01,Reference Identification Qualifier,Code qualifying the Reference Identification,R,G1 : Prior Authorization Number,,,,,
2300.REF02,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier",R,,,SUBMITTED_CLAIM,PRIOR_AUTHORIZATION,,
...
2300.REF02,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier",R,,,SUBMITTED_CLAIM,HCC_CLAIM_NUMBER,,
...
2300.REF01,Reference Identification Qualifier,Code qualifying the Reference Identification,R,D9 : Claim Number,,,,,
2300.REF02,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier",R,,,SUBMITTED_CLAIM,CLEARINGHOUSE_TRACE_NUMBER,,
...
2300.REF02,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier",R,,,SUBMITTED_CLAIM,AUTO_ACCIDENT_STATE,,
Segment - REF Medical Record Number (Situational),,,,,,,,,
2300.REF01,Reference Identification Qualifier,Code qualifying the Reference Identification,R,EA Medical Record Identification Number,,,,,
2300.REF02,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier",R,,,SUBMITTED_CLAIM,MEDICAL_RECORD_NUMBER,,
...
2300.NTE02,Description,A free-form description to clarify the related data elements and their content  /  Claim Note Text,R,,,SUBMITTED_CLAIM,CLAIM_NOTE,,
Segment - NTE Billing Note (Situational),,,,,,,,,
2300.NTE01,Note Reference Code,Code identifying the functional area or purpose for which the note applies,R,"ADD : Additional Information
CER : Certification Narrative
DCP : Goals, Rehabilitation Potential, or Discharge Plans",,,,,
2300.NTE02,Description,A free-form description to clarify the related data elements and their content  /  Claim Note Text,R,,,SUBMITTED_CLAIM,BILLING_NOTE,,
...
L2 : Replacement Due to Loss or Theft L3 : Replacement Due to Breakage or Damage
L4 : Replacement Due to Patient Preference
 L5 : Replacement Due to Medical Reason",,SUBMITTED_CLAIM_AMBULANCE_CERTIFICATION,CONDITION_CODE_1,,
...
including dental referrals).",,SUBMITTED_CLAIM_AMBULANCE_CERTIFICATION,CONDITION_CODE_2,,
...
treatment for at least one health problem identified
during an initial or periodic screening service (not
including dental referrals).",,SUBMITTED_CLAIM_AMBULANCE_CERTIFICATION,CONDITION_CODE_3,,
...
BK : ICD9 -CM - Principal Diagnosis",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI01.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI01.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
...
Modification (ICD-10-CM) Admitting Diagnosis",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI01.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
Modification (ICD-9-CM) Patient’s Reason for Visit",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI01.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
PR- International Classification of Diseases Clinical
Modification (ICD-9-CM) Patient’s Reason for Visit",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI02.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI03.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"APR - International Classification of Diseases Clinical
Modification (ICD-10-CM) Patient’s Reason for Visit
PR- International Classification of Diseases Clinical
Modification (ICD-9-CM) Patient’s Reason for Visit",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI03.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
Code (E-codes)",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI01.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI01.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
2300.HI02.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"ABN : International Classification of Diseases Clinical
...
Code (E-codes)",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI02.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI02.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
2300.HI03.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"ABN : International Classification of Diseases Clinical
Modification (ICD-10-CM) External Cause of Injury
Code
...
Code (E-codes)",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI03.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI03.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
...
Modification (ICD-9-CM) External Cause of Injury
Code (E-codes)",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI04.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI04.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
...
Modification (ICD-9-CM) External Cause of Injury
Code (E-codes)",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI05.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI05.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
...
Modification (ICD-9-CM) External Cause of Injury
Code (E-codes)",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI06.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI06.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
...
Modification (ICD-9-CM) External Cause of Injury
Code (E-codes)",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI07.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI07.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
...
Modification (ICD-9-CM) External Cause of Injury
Code (E-codes)",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI08.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI08.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
...
Modification (ICD-9-CM) External Cause of Injury
Code (E-codes)",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI09.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI09.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
...
Modification (ICD-9-CM) External Cause of Injury
Code (E-codes)",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI10.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI10.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
...
Modification (ICD-9-CM) External Cause of Injury
Code (E-codes)",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI11.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI11.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
...
Modification (ICD-9-CM) External Cause of Injury
Code (E-codes)",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI12.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI12.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
Segment - HI Diagnosis Related Group (DRG) Information (Situational),,,,,,,,,
2300.HI01.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,DR Diagnosis Related Group (DRG),,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI01.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
Segment - HI Other Diagnosis Information (Situational),,,,,,,,,
2300.HI01.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,ABF International Classification of Diseases Clinical Modification (ICD-10-CM) Diagnosis,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI01.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI01.09,Yes/No Condition or Response Code,Code indicating a Yes or No condition or response,S,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,POA_INDICATOR,,
2300.HI02.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,ABF International Classification of Diseases Clinical Modification (ICD-10-CM) Diagnosis,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
...
Codes",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI01.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
2300.HI01.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
...
Modification (ICD-10-PCS) Other Procedure Codes",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI01.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI01.03,Date Time Period Format Qualifier,"Code indicating the date format, time format, or date and time format",R,D8 Date Expressed in Format CCYYMMDD,,,,,
2300.HI01.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
2300.HI02.01,Code List Qualifier Code,"Code identifying a specific industry code list
...
2300.HI02.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
2300.HI03.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"BBQ International Classification of Diseases Clinical
Modification (ICD-10-PCS) Other Procedure Codes",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI03.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
2300.HI03.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
2300.HI04.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"BBQ International Classification of Diseases Clinical
Modification (ICD-10-PCS) Other Procedure Codes",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI04.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
2300.HI04.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
2300.HI05.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"BBQ International Classification of Diseases Clinical
Modification (ICD-10-PCS) Other Procedure Codes",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI05.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
2300.HI05.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
2300.HI06.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"BBQ International Classification of Diseases Clinical
Modification (ICD-10-PCS) Other Procedure Codes",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI06.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
2300.HI06.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
2300.HI07.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"BBQ International Classification of Diseases Clinical
Modification (ICD-10-PCS) Other Procedure Codes",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI07.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
2300.HI07.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
2300.HI08.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"BBQ International Classification of Diseases Clinical
Modification (ICD-10-PCS) Other Procedure Codes",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI08.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
2300.HI08.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
2300.HI09.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"BBQ International Classification of Diseases Clinical
Modification (ICD-10-PCS) Other Procedure Codes",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI09.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
2300.HI09.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
2300.HI10.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"BBQ International Classification of Diseases Clinical
Modification (ICD-10-PCS) Other Procedure Codes",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI10.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
2300.HI10.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
2300.HI11.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"BBQ International Classification of Diseases Clinical
Modification (ICD-10-PCS) Other Procedure Codes",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI11.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
2300.HI11.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
2300.HI12.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,"BBQ International Classification of Diseases Clinical
Modification (ICD-10-PCS) Other Procedure Codes",,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI12.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
2300.HI12.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
Segment - HI Occurrence Span Information (Situational),,,,,,,,,
2300.HI01.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BI - Occurrence Span,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI01.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
2300.HI01.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BH - Occurrence,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI01.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI01.03,Date Time Period Format Qualifier,"Code indicating the date format, time format, or date and time format",R,D8 - Date Expressed in Format CCYYMMDD,,,,,
2300.HI01.04,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DATE_TIME_PERIOD,,
2300.HI02.01,Code List Qualifier Code,"Code identifying a specific industry code list
...
2300.HI01.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BE -Value,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI01.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI01.05,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,VALUE_CODE_AMOUNT,,
2300.HI02.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BE -Value,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI02.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI02.05,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,VALUE_CODE_AMOUNT,,
2300.HI03.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BE -Value,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI03.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI03.05,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,VALUE_CODE_AMOUNT,,
2300.HI04.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BE -Value,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI04.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI04.05,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,VALUE_CODE_AMOUNT,,
2300.HI05.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BE -Value,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI05.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI05.05,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,VALUE_CODE_AMOUNT,,
2300.HI06.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BE -Value,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI06.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI06.05,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,VALUE_CODE_AMOUNT,,
2300.HI07.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BE -Value,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI07.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI07.05,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,VALUE_CODE_AMOUNT,,
2300.HI08.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BE -Value,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI08.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI08.05,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,VALUE_CODE_AMOUNT,,
2300.HI09.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BE -Value,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI09.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI09.05,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,VALUE_CODE_AMOUNT,,
2300.HI10.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BE -Value,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI10.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI10.05,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,VALUE_CODE_AMOUNT,,
2300.HI11.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BE -Value,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI11.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI11.05,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,VALUE_CODE_AMOUNT,,
2300.HI12.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BE -Value,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI12.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI12.05,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,VALUE_CODE_AMOUNT,,
Segment - HI Condition Information (Situational),,,,,,,,,
2300.HI01.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BG - Condition,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI01.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
2300.HI02.01,Code List Qualifier Code,"Code identifying a specific industry code list
Principal Diagnosis Type Code",R,BG - Condition,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_QUALIFIER,,
2300.HI02.02,Industry Code,Diagnosis Code,R,,,SUBMITTED_CLAIM_DIAGNOSIS_INFO,DIAGNOSIS_CODE,,
...
individual",R,1 Person,,,,,
2310A.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_ATTENDING_PROV_LAST_NAME,,
2310A.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_ATTENDING_PROV_FIRST_NAME,,
2310A.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_ATTENDING_PROV_MIDDLE_NAME,,
2310A.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_ATTENDING_PROV_NAME_SUFFIX,,
2310A.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code",S,"XX Centers for Medicare and Medicaid Services
National Provider Identifier",,,,,
2310A.NM109,Identification Code,Code identifying a party or other code /Rendering Provider Identifier,S,1851470140,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_ATTENDING_PROV_IDENTIFICATION_CODE,,
...
LU: Location Numbe",,,,,
2310A.REF02,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier",R,0121T3B0B,,,,,
...
2310B.NM102,Entity Type Qualifier,"Code identifying an organizational entity, a physical location, property or an
individual",R,1 - Person,,,,,
2310B.NM103,Name Last or Organization Name,Individual last name or organizational name,R,Individual last name or organizational name,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_OPERATING_PHYSICIAN_LAST_NAME,,
2310B.NM104,Name First,Individual first name,S,Individual first name,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_OPERATING_PHYSICIAN_FIRST_NAME,,
2310B.NM105,Name Middle,Individual middle name or initial,S,Individual middle name or initial,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_OPERATING_PHYSICIAN_MIDDLE_NAME,,
2310B.NM107,Name Suffix,Suffix to individual name,S,Suffix to individual name,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_OPERATING_PHYSICIAN_NAME_SUFFIX,,
2310B.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code",S,"XX Centers for Medicare and Medicaid Services
National Provider Identifier",,,,,
2310B.NM109,Identification Code,Code identifying a party or other code /Rendering Provider Identifier,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_OPERATING_PHYSICIAN_IDENTIFICATION_CODE,,
Segment - REF Operating Physician Secondary Identification (Situational),,,,,,,,,
2310B.REF01,Reference Identification Qualifier,Code qualifying the Reference Identification,R,,,,,,
...
individual",R,1 :  Person,,,,,
2310C.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_OTHER_OPERATING_PHYSICIAN_LAST_NAME,,
2310C.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_OTHER_OPERATING_PHYSICIAN_FIRST_NAME,,
2310C.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_OTHER_OPERATING_PHYSICIAN_MIDDLE_NAME,,
2310C.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_OTHER_OPERATING_PHYSICIAN_NAME_SUFFIX,,
2310C.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code",S,"XX Centers for Medicare and Medicaid Services
National Provider Identifier",,,,,
2310C.NM109,Identification Code,Code identifying a party or other code /Rendering Provider Identifier,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_OTHER_OPERATING_PHYSICIAN_IDENTIFICATION_CODE,,
...
2310D.NM101,Entity Identifier Code,"Code identifying an organizational entity, a physical location, property or an
individual",R,82 :Rendering Provider,,,,removed mapping since latest Inbound 837I doesn't have these fields mapped,
...
2310F.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_REFERRING_PROVIDER_LAST_NAME,,
2310F.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_REFERRING_PROVIDER_FIRST_NAME,,
2310F.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_REFERRING_PROVIDER_MIDDLE_NAME,,
2310F.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_REFERRING_PROVIDER_NAME_SUFFIX,,
2310F.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code (67)",S,"XX Centers for Medicare and Medicaid Services
National Provider Identifier",,,,,
2310F.NM109,Identification Code,Code identifying a party or other code,S,,,SUBMITTED_CLAIM_PROVIDER_DETAILS,CLAIMLVL_REFERRING_PROVIDER_IDENTIFICATION_CODE,,
...
Loop 2320 (Situational),,A record is inserted into SUBMITTED_CLAIM_OTHER_SUBSCRIBER  table for each occurrence of 2320 loop.,,,,,,,
...
40 Cadaver Donor
53 Life Partner
G8 Other Relationship",18,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,RELATIONSHIP_TO_INSURED,Relationship to insured subscriber,
2320.SBR03,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier/Insured Group or Policy Number",S,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,INSURED_GROUP_NUMBER,,
2320.SBR04,Name,Free-form name,S,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_GROUP_NAME,,
2320.SBR09,Claim Filing Indicator Code,Code identifying type of claim,S,"MA Medicare Part A
MB Medicare Part B
MC Medicaid
OF Other Federal Program",,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,CLAIM_FILLING_INDICATOR,,
...
2320.AMT01,Amount Qualifier Code,Code to qualify amount,R,EAF Amount Owed,,,,,
2320.AMT02,Monetary Amount,Monetary amount,R,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,REMAINING_PATIENT_LIABILITY,,
...
benefits.
Y :  Yes",,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,BENEFITS_ASSIGNMENT_CERTIFICATION_INDICATOR,Benefits assignment certification indicator,
2320.OI06,Release of Information Code,Code indicating whether the provider has on file a signed statement by the patient authorizing the release of medical data to other organizations,R,"I  : Informed Consent to Release Medical Information
...
signature be collected.",,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,INFORMATION_RELEASE_CERTIFICATION_INDICATOR,Information release certification indicator,
Segment - MIA Inpatient Adjudication Information (Situational)                    A record is inserted into SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO  table for each occurrence of MIA segment.,,,,,,,,,
2320.MIA01,Quantity,Numeric value of quantity,R,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,COVERED_DAYS_OR_VISITS_COUNT,Covered days or number of visits,
2320.MIA03,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,LIFETIME_PSYCHIATRIC_DAYS_COUNT,,
2320.MIA04,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,CLAIM_DRG_AMOUNT,,
2320.MIA05,Reference Identification,"Reference information as defined for a particular Transaction Set or as specified
by the Reference Identification Qualifier",S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,CLAIM_PAYMENT_REMARK_CODE,Claim payment remark code,
2320.MIA06,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,CLAIM_DISPROPORTIONATE_SHARE_AMOUNT,Claim Disproportionate Share AMOUNT,
2320.MIA07,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,CLAIM_MSP_PASS_THROUGH_AMOUNT,,
2320.MIA08,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,CLAIM_PPS_CAPITAL_AMOUNT,Clam PPS capital amount,
2320.MIA09,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,PPS_CAPITAL_FSP_DRG_AMOUNT,,
2320.MIA10,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,PPS_CAPITAL_HSP_DRG_AMOUNT,,
2320.MIA11,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,PPS_CAPITAL_DSH_DRG_AMOUNT,,
2320.MIA12,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,OLD_CAPITAL_AMOUNT,Old capital amount,
2320.MIA13,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,PPS_CAPITAL_IME_AMOUNT,,
2320.MIA14,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,PPS_OPERATING_HOSPITAL_SPECIFIC_DRG_AMOUNT,,
2320.MIA15,Quantity,Numeric value of quantity,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,COST_REPORT_DAY_COUNT,,
2320.MIA16,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,PPS_OPERATING_FEDERAL_SPECIFIC_DRG_AMOUNT,,
2320.MIA17,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,CLAIM_PPS_CAPITAL_OUTLIER_AMOUNT,Claim PPS capital outlier amount,
2320.MIA18,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,CLAIM_INDIRECT_TEACHING_AMOUNT,Claim indirect teaching amount,
2320.MIA19,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,NON_PAYABLE_PROFESSIONAL_COMPONENT_BILLED_AMOUNT,Non payable proffesional component billed amount,
2320.MIA20,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,CLAIM_PAYMENT_REMARK_CODE_1,Claim payment remark code 1,
2320.MIA21,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,CLAIM_PAYMENT_REMARK_CODE_2,Claim payment remark code 2,
2320.MIA22,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,CLAIM_PAYMENT_REMARK_CODE_3,Claim payment remark code 3,
2320.MIA23,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,CLAIM_PAYMENT_REMARK_CODE_4,Claim payment remark code 4,
2320.MIA24,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_INPATIENT_INFO,PPS_CAPITAL_EXCEPTION_AMOUNT,,
Segment - MOA Outpatient Adjudication Information (Situational)                       A record is inserted into SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO  table for each occurrence of MOA segment.,,,,,,,,,
2320.MOA01,Percentage as Decimal,"Percentage expressed as a decimal (e.g., 0.0 through 1.0 represents 0% through
100%)",S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO.,REIMBURSEMENT_RATE,Reimbulsement rate,
2320.MOA02,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO.,HCPCS_PAYABLE_AMOUNT,HCPCS payable amount,
2320.MOA03,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO.,CLAIM_PAYMENT_REMARK_CODE_1,Claim payment remark code 1,
2320.MOA04,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO.,CLAIM_PAYMENT_REMARK_CODE_2,Claim payment remark code 2,
2320.MOA05,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO.,CLAIM_PAYMENT_REMARK_CODE_3,Claim payment remark code 3,
2320.MOA06,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO.,CLAIM_PAYMENT_REMARK_CODE_4,Claim payment remark code 4,
2320.MOA07,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO.,CLAIM_PAYMENT_REMARK_CODE_5,Claim payment remark code 5,
2320.MOA08,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO.,ESRD_PAYMENT_AMOUNT,ESRD payment amount,
2320.MOA09,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_MEDICARE_OUTPATIENT_INFO.,NON_PAYABLE_PROF_COMP_BILLED_AMOUNT,,
...
2330A.NM102,Entity Type Qualifier,Code qualifying the type of entity,R,"1 : Person
2 : Non-Person Entity",,,,,
2330A.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_LAST_NAME,,
2330A.NM104,Name First,Individual first name,S,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_FIRST_NAME,,
2330A.NM105,Name Middle,Individual middle name or initial,S,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_MIDDLE_NAME,,
2330A.NM107,Name Suffix,Suffix to individual name,S,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_NAME_SUFFIX,,
2330A.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code (",R,PI  : Payor Identification,,,,,
2330A.NM109,Identification Code,Code identifying a party or other code,R,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_INDENTIFICATION_CODE,,
Segment - N3 Other Subscriber Address (Situational),,,,,,,,,
2330A.N301,Address Information,Address Information,R,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,"OTHER_INSURED_ADDRESS_LINE_1
Other Insured Subscriber Address Line1",Other Insured Subscriber Address Line1,
2330A.N302,Address Information,Address Information,S,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,"OTHER_INSURED_ADDRESS_LINE_2
Other Insured Subscriber Address Line2",Other Insured Subscriber Address Line2,
Segment - N4 Other Subscriber City/State/ZIP Code (Situational),,,,,,,,,
2330A.N401,City Name,Free-form text for city name,R,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_CITY,Other Insured Subscriber City,
2330A.N402,State or Province Code,Code (Standard State/Province) as defined by appropriate government agency,S,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_STATE,Other Insured Subscriber State,
2330A.N403,Postal Code,"Code defining international postal zone code excluding punctuation and blanks
(zip code for United States)",S,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_ZIP,Other Insured Subscriber Zip,
2330A.N404,Country Code,Code identifying the country,S,,,,,,
2330A.N407,Country Subdivision Code,Code identifying the country subdivision,S,,,,,,
...
2330A.REF02,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,R,,,SUBMITTED_CLAIM_OTHER_SUBSCRIBER,OTHER_INSURED_ADDITIONAL_IDENTIFIER,"Other insured additional identifier
when we have multiple REF02 map the first instance",
Loop 2330B(Situational),,,,A record is inserted into SUBMITTED_CLAIM_OTHER_PAYER  table for each occurrence of 2330B loop.,,,,,
...
2330B.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code",R,,,,,,
2330B.NM109,Identification Code,Code identifying a party or other code,R,,,"SUBMITTED_CLAIM_OTHER_PAYER, SUBMITTED_CLAIM_LEVEL_ADJUSTMENTS,",OTHER_PAYER_PRIMARY_IDENTIFIER,Other payor primary identifier,
...
(zip code for United States)",S,,,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_OTHER_PAYER_ZIP,,
2330B.N404,Country Code,Code identifying the country,S,,US,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_OTHER_PAYER_COUNTRY,,
2330B.N407,Country Subdivision Code,Code identifying the country subdivision,S,,,,,,
Segment - DTP Claim Check or Remittance Date (Situational),,,,,,,,,
2330B.DTP01,Date/Time Qualifier,"Code specifying type of date or time, or both date and time",R,573 : Date Claim Paid,,,,,
2330B.DTP02,Date Time Period Format Qualifier,"Code indicating the date format, time format, or date and time format",R,D8 :Date Expressed in Format CCYYMMDD,,,,,
2330B.DTP03,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,,,SUBMITTED_CLAIM_OTHER_PAYER,ADJUDICATION_OR_PAYMENT_DATE,Adjuntication or payment date,
...
2330B.REF01,Reference Identification Qualifier,Code qualifying the Reference Identification,R,F8 : Original Reference Number,,,,,
2330B.REF02,Reference Identification,Reference information as defined for a particular Transaction Set or as specified by the Reference Identification Qualifier,R,,,SUBMITTED_CLAIM_OTHER_PAYER,CLAIM_OTHER_PAYER_CONTROL_NUMBER,,
...
Loop 2400 (Required),,,,A record is inserted into SUBMITTED_CLAIM_LINE table for each occurene of 2400 loop.,,,,,
Segment - LX Service Line Number (Required),,,,,,,,,
2400.LX01,Assigned Number,Number assigned for differentiation within a transaction set,R,1,,SUBMITTED_CLAIM_LINE,SUBMITTED_LINE_NUMBER,Submitted Claim Line number,
Segment - SV2 Institutional Service Line (Required),,,,,,,,,
2400.SV201,Product/Service ID,Identifying number for a product or service,R,900,,SUBMITTED_CLAIM_LINE,SERVICE_LINE_REVENUE_CODE,,
...
(HIPPS) Skilled Nursing Facility Rate Code",,,,,
2400.SV202.02,Product/Service ID,Identifying number for a product or service,R,H0023,,SUBMITTED_CLAIM_LINE,SERVICE_CODE,,
2400.SV202.03,Procedure Modifier,"This identifies special circumstances related to the performance of the
service, as defined by trading partners",S,HE,,SUBMITTED_CLAIM_LINE,PROCEDURE_MOD_1,,
2400.SV202.04,Procedure Modifier,"This identifies special circumstances related to the performance of the
service, as defined by trading partners",S,HT,,SUBMITTED_CLAIM_LINE,PROCEDURE_MOD_2,,
2400.SV202.05,Procedure Modifier,"This identifies special circumstances related to the performance of the
service, as defined by trading partners",S,,,SUBMITTED_CLAIM_LINE,PROCEDURE_MOD_3,,
2400.SV202.06,Procedure Modifier,"This identifies special circumstances related to the performance of the
service, as defined by trading partners",S,,,SUBMITTED_CLAIM_LINE,PROCEDURE_MOD_4,,
2400.SV202.07,Description,"A free-form description to clarify the related data elements and their
content",S,,,,,,
2400.SV203,Monetary Amount,Monetary Amount,R,200,,SUBMITTED_CLAIM_LINE,LINE_ITEM_AMOUNT,,
...
a measurement has been taken",R,"DA : Days
UN : Unit",,SUBMITTED_CLAIM_LINE,LINE_ITEM_UNITS,,
2400.SV205,Quantity,Numeric value of quantity,R,1,,SUBMITTED_CLAIM_LINE,LINE_ITEM_QUANTITY,,
2400.SV207,Monetary Amount,Monetary Amount,S,,,SUBMITTED_CLAIM_LINE,NON_CONVERED_CHARGE_AMOUNT,,
...
RD8 :Range of Dates Expressed in Format CCYYMMDDCCYYMMDD",,,,,
2400.DTP03,Date Time Period,"Expression of a date, a time, or range of dates, times or dates and times",R,"Expression of a date, a time, or range of dates, times or dates and times",,SUBMITTED_CLAIM_LINE,LINE_SERVICE_DT,,
...
2400.NTE02,Description,A free-form description to clarify the related data elements and their content,R,,,SUBMITTED_CLAIM_LINE,LINE_NOTE_TEXT,,
...
2410.LIN02,Product/Service ID Qualifier,"Code identifying the type/source of the descriptive number used in
Product/Service ID",R,N4 National Drug Code in 5-4-2 Format,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,DRUG_CODE,,
2410.LIN03,Product/Service ID,Identifying number for a product or service,R,,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,DRUG_PRODUCT_ID,,
Segment - CTP Drug Quantity (Required),,,,,,,,,
2410.CTP04,Quantity,Numeric value of quantity,R,,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,DRUG_QUANTITY,,
2410.CTP05-1,COMPOSITE UNIT OF MEASURE-Unit or Basis for Measurement Code,To identify a composite unit of measure,R,,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,DRUG_QUANTITY_MEASURE,,
...
individual",R,72 Operating Physician,,,,,
2420A.NM102,Entity Type Qualifier,Code qualifying the type of entity,R,1 Person,,,,,
2420A.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_LINE,OPERATING_PHYSICIAN_LAST_NAME,Last Name of the operating Physician,
2420A.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_LINE,OPERATING_PHYSICIAN_FIRST_NAME,First Name of the operating Physician,
2420A.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_LINE,OPERATING_PHYSICIAN_MIDDLE_NAME,Middle Name of the operating Physician,
2420A.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_LINE,OPERATING_PHYSICIAN_NAME_SUFFIX,Name Suffix of the operating Physician,
2420A.NM108,Identification Code Qualifier,"Code designating the system/method of code structure used for Identification
Code",S,"XX Centers for Medicare and Medicaid Services
National Provider Identifier",,,,,
2420A.NM109,Identification Code,Code identifying a party or other code,S,,,SUBMITTED_CLAIM_LINE,OPERATING_PHYSICIAN_IDENTIFIER,Unique Identifier for a operating Physician,
Segment - REF Operating Physician Secondary Identification (Situational),,,,,,,,,
2420A.REF01,Reference Identification Qualifier,Code qualifying the Reference Identification,R,"0B State License Number
1G Provider UPIN Number
G2 Provider Commercial Number
...
individual",R,ZZ Mutually Defined,,,,,
2420B.NM102,Entity Type Qualifier,Code qualifying the type of entity,R,1 Person,,,,,
2420B.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_LINE,OTHER_OPERATING_PHYSICIAN_LAST_NAME,Last Name of the other operating Physician,
2420B.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_LINE,OTHER_OPERATING_PHYSICIAN_FIRST_NAME,First Name of the other operating Physician,
2420B.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_LINE,OTHER_OPERATING_PHYSICIAN_MIDDLE_NAME,Middle Name of other operating Physician,
2420B.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_LINE,OTHER_OPERATING_PHYSICIAN_NAME_SUFFIX,Name Suffix of other operating Physician,
2420B.NM108,Identification Code Qualifier,,S,XX Centers for Medicare and Medicaid Services National Provider Identifier,,,,,
2420B.NM109,Identification Code,Code identifying a party or other code,S,,,SUBMITTED_CLAIM_LINE,OTHER_OPERATING_PHYSICIAN_IDENTIFIER,Unique Identifier for an other operating Physician,
Segment - REF Other Operating Physician Secondary Identification (Situational),,,,,,,,,
2420B.REF01,Reference Identification Qualifier,Code qualifying the Reference Identification,R,"0B State License Number
1G Provider UPIN Number
G2 Provider Commercial Number
...
2420C.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_LINE,RENDERING_PROVIDER_LAST_NAME,Last Name of Rendering Provider,
2420C.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_LINE,RENDERING_PROVIDER_FIRST_NAME,First Name of Rendering Provider,
2420C.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_LINE,RENDERING_PROVIDER_MIDDLE_NAME,Middle Name of Rendering Provider,
2420C.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_LINE,RENDERING_PROVIDER_NAME_SUFFIX,Name Suffix of Rendering Provider,
2420C.NM108,Identification Code Qualifier,,S,"XX Centers for Medicare and Medicaid Services
National Provider Identifier",,,,,
2420C.NM109,Identification Code,Code identifying a party or other code,S,,,SUBMITTED_CLAIM_LINE,RENDERING_PROVIDER_IDENTIFIER,Unique Identifier for a rendering Provider,
Segment - REF Rendering Provider Secondary Identification (Situational),,,,,,,,,
...
individual",R,DN Referring Provider,,,,,
2420D.NM102,Entity Type Qualifier,Code qualifying the type of entity,R,1 Person,,,,,
2420D.NM103,Name Last or Organization Name,Individual last name or organizational name,R,,,SUBMITTED_CLAIM_LINE,REFERRING_PROVIDER_LAST_NAME,Last Name of Referring Provider,
2420D.NM104,Name First,Individual first name,S,,,SUBMITTED_CLAIM_LINE,REFERRING_PROVIDER_FIRST_NAME,First Name of Referring Provider,
2420D.NM105,Name Middle,Individual middle name or initial,S,,,SUBMITTED_CLAIM_LINE,REFERRING_PROVIDER_MIDDLE_NAME,Middle Name of Referring Provider,
2420D.NM107,Name Suffix,Suffix to individual name,S,,,SUBMITTED_CLAIM_LINE,REFERRING_PROVIDER_NAME_SUFFIX,Name Suffix of Referring Provider,
2420D.NM108,Identification Code Qualifier,,S,"XX Centers for Medicare and Medicaid Services
National Provider Identifier",,,,,
2420D.NM109,Identification Code,Code identifying a party or other code,S,,,SUBMITTED_CLAIM_LINE,REFERRING_PROVIDER_IDENTIFIER,Unique Identifier for a refering Provider,
Segment - REF Referring Provider Secondary Identification (Situational),,,,,,,,,
2420D.REF01,Reference Identification Qualifier,Code qualifying the Reference Identification,R,"0B State License Number
1G Provider UPIN Number
G2 Provider Commercial Number
...
2430.SVD01,Identification Code,Code identifying a party or other code,R,,,SUBMITTED_CLAIM_LINE_LEVEL_ADJUSTMENTS,OTHER_PAYER_PRIMARY_IDENTIFIER,,
2430.SVD02,Monetary Amount,Monetary Amount,R,,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,SERVICE_LINE_PAID_AMOUNT,,
,,,,,,,,,
...
2430.DTP03,Date Time Period,,R,,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,CLAIM_LINE_REMITTENCE_DATE,,
Segment - AMT Remaining Patient Liability (Situational),,,,,,,,,
2430.AMT01,Amount Qualifier Code,Code to qualify amount,R,EAF Amount Owed,,,,,
2430.AMT02,Monetary Amount,Monetary Amount/Remaining Patient Liability,R,,,SUBMITTED_CLAIM_CLAIMLINE_OTHERDETAILS,REMAINING_PATIENT_LIABILITY,,
Segment SE (Required),,,,,,,,,
...
## Repository/Claims/V26.1.1.0/EdifecsProduct_MappingSpec_ClaimsRepo_837IP_EDI_to_DFFConversion_V2.1.xlsx — CAS

```csv
CLAIM_LEVEL_ADJUSTMENTS,,,
,CLAIM_ADJUSTMENT_GROUP_CODE_1,,
,CLAIM_ADJUSTMENT_REASON_CODE_1,,
,CLAIM_ADJUSTMENT_AMT_1,,
,CLAIM_ADJUSTMENT_QTY_1,,`
,CLAIM_ADJUSTMENT_REASON_CODE_2,,
,CLAIM_ADJUSTMENT_AMT_2,,
,CLAIM_ADJUSTMENT_QTY_2,,
,CLAIM_ADJUSTMENT_REASON_CODE_3,,
,CLAIM_ADJUSTMENT_AMT_3,,
,CLAIM_ADJUSTMENT_QTY_3,,
,CLAIM_ADJUSTMENT_REASON_CODE_4,,
,CLAIM_ADJUSTMENT_AMT_4,,
,CLAIM_ADJUSTMENT_QTY_4,,
,CLAIM_ADJUSTMENT_REASON_CODE_5,,
,CLAIM_ADJUSTMENT_AMT_5,,
,CLAIM_ADJUSTMENT_QTY_5,,
,CLAIM_ADJUSTMENT_REASON_CODE_6,,
,CLAIM_ADJUSTMENT_AMT_6,,
,CLAIM_ADJUSTMENT_QTY_6,,
...
,CLAIM_ADJUSTMENT_AMT_6,,
,CLAIM_ADJUSTMENT_QTY_6,,
CLAIM_LINE_LEVEL_ADJUSTMENTS,,,
,CLAIM_LINE_ADJUSTMENT_GROUP_CODE_1,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_1,,
,CLAIM_LINE_ADJUSTMENT_AMT_1,,
,CLAIM_LINE_ADJUSTMENT_QTY_1,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_2,,
,CLAIM_LINE_ADJUSTMENT_AMT_2,,
,CLAIM_LINE_ADJUSTMENT_QTY_2,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_3,,
,CLAIM_LINE_ADJUSTMENT_AMT_3,,
,CLAIM_LINE_ADJUSTMENT_QTY_3,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_4,,
,CLAIM_LINE_ADJUSTMENT_AMT_4,,
,CLAIM_LINE_ADJUSTMENT_QTY_4,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_5,,
,CLAIM_LINE_ADJUSTMENT_AMT_5,,
,CLAIM_LINE_ADJUSTMENT_QTY_5,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_6,,
,CLAIM_LINE_ADJUSTMENT_AMT_6,,
,CLAIM_LINE_ADJUSTMENT_QTY_6,,
,CLAIM_LINE_ADJUSTMENT_GROUP_CODE_2,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_1,,
,CLAIM_LINE_ADJUSTMENT_AMT_1,,
,CLAIM_LINE_ADJUSTMENT_QTY_1,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_2,,
...
,CLAIM_LINE_ADJUSTMENT_AMT_6,,
,CLAIM_LINE_ADJUSTMENT_QTY_6,,
,CLAIM_LINE_ADJUSTMENT_GROUP_CODE_3,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_1,,
,CLAIM_LINE_ADJUSTMENT_AMT_1,,
,CLAIM_LINE_ADJUSTMENT_QTY_1,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_2,,
...
,CLAIM_LINE_ADJUSTMENT_AMT_6,,
,CLAIM_LINE_ADJUSTMENT_QTY_6,,
,CLAIM_LINE_ADJUSTMENT_GROUP_CODE_4,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_1,,
,CLAIM_LINE_ADJUSTMENT_AMT_1,,
,CLAIM_LINE_ADJUSTMENT_QTY_1,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_2,,
...
,CLAIM_LINE_ADJUSTMENT_AMT_6,,
,CLAIM_LINE_ADJUSTMENT_QTY_6,,
,CLAIM_LINE_ADJUSTMENT_GROUP_CODE_5,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_1,,
,CLAIM_LINE_ADJUSTMENT_AMT_1,,
,CLAIM_LINE_ADJUSTMENT_QTY_1,,
,CLAIM_LINE_ADJUSTMENT_REASON_CODE_2,,
...
## Repository/Claims/V26.1.1.0/EdifecsProduct_MappingSpec_ClaimsRepo_837IP_EDI_to_DFFConversion_V2.1.xlsx — Sheet1
...
## Repository/Enrollment/V26.1.1.0/EdifecsProduct_MappingSpec_EnrollmentRepo_834_EDI_to_DFFConversion_V2.0.xlsx — Cover Page

```csv
Mapping Specification,,,,,,,,,
,,,,,,,,,
Business Area: Inbound Enrollment Repository (EDI 834),,,,,,,,,
,,,,,,,,,
This document provides the Mapping Specification for Inbound EDI 834 Enrollment Repository. Document is intended for EDIFECS Product Team,,,,,,,,,
,,,,,,,,,
,,,,,,,,,
,,,,Version,,V24.2.0.0,,,
,,,,,,,,,
...
## Repository/Enrollment/V26.1.1.0/EdifecsProduct_MappingSpec_EnrollmentRepo_834_EDI_to_DFFConversion_V2.0.xlsx — Revision History
...
,,,,
V#,Date,Author,Reviewer(s)/ Contributor(s),Comments
0.1,16-06-2023,Ambily Raj,Shijila M,Initial Version
0.2,18-6-2023,Ambily Raj,Shijila M,Changes as per review comments.
1,20-6-2023,Ambily Raj,Shijila M,Baselined.
2,31-5-2024,Ambily Raj,Shijila M,Updated the mapping Logic for 2300.DT*349 - (PSD-2452)
```

## Repository/Enrollment/V26.1.1.0/EdifecsProduct_MappingSpec_EnrollmentRepo_834_EDI_to_DFFConversion_V2.0.xlsx — Tables

```csv
No,Table Name
1,Enr_Member_HCC_ID_LookUp
2,Enr_Member
3,Enr_Member_Supplemental_Identification
4,Enr_Member_Plan_Selection
5,Enr_Address
6,Enr_Communication_Numbers
7,Enr_Member_Language
8,Enr_Member_Race_Or_Ethnicity
9,Enr_Member_Custodial_Parent
10,Enr_Member_Responsible_Party
11,Enr_Member_Reporting_Category
12,Enr_Member_Reporting_Category_Identifiers
,
Attribute Details:,
```

## Repository/Enrollment/V26.1.1.0/EdifecsProduct_MappingSpec_EnrollmentRepo_834_EDI_to_DFFConversion_V2.0.xlsx — EDI 834

```csv
LoopID.Segment ID,Segment Name,Element Description,Enumeration Values,Integration Plus Table  Name.Column Name,Mapping Logic
...
ISA08,Interchange Receiver ID,The Trading Partner ID (TPID) assigned by the Client,,,
...
Enter current date in the CCYYMMDD format",,,
...
REF02,Reference Identification,op,,,
...
ET Employee Total
TO Total",,
QTY02,Quantity,Record Totals,,,
1000A — SPONSOR NAME Loop Repeat: 1,,,,,
1000A.N1,Sponsor Name,,,,
1000A.N101,Entity Identifier Code,,P5 = Plan sponsor,,
1000A.N102,Plan Sponsor Name,Plan Sponsor Name,,Enr_Member.Sponsor _Name,
1000A.N103,Identification Code Qualifier,,FI = Federal Tax ID Number,,
1000A.N104,Identification Code,Sponsor Identifier,,Enr_Member.Sponsor_ Identification,
...
1000B.N102,Name,Insurer Name,,Enr_Member.Payer_Name,
1000B.N103,Identification Code Qualifier,,FI = Federal Tax ID number,,
1000B.N104,Identification Code,Insurer Identification Code,,Enr_Member.Payer_ldentiftation,
...
1000C.N102,Name,TPA/Broker Name (free-form),,Enr_Member.Broker_Name,Map the first Instance of  1000C.N101 = BO
1000C.N103,Identification Code Qualifier,,FI = Federal Tax ID number,,
1000C.N104,Identification Code,TPA or Broker Identification Code,,Enr_Member.Broker_Identification,Map the first Instance of 1000C.N101 = BO
1100C — TPA/BROKER ACCOUNT INFORMATION Loop Repeat: 1,,,,,
1100C.ACT,TPA/BROKER ACCOUNT INFORMATION,,,,
1100C.ACT1,"Account
Number",TPA or Broker Account Number,,Enr_Member.Broker_License_Number,
1100C. ACT02,Name,,,,
...
2000 — MEMBER LEVEL DETAIL Loop Repeat: >1    A record is inserted into Parent table(Enr_Member )  for each 2000.INS,,,,,
2000.INS,Member Level Detail,,,,
2000.INS01,Subscriber Indicator,,"Y :Yes
N :No",Enr_Member.Is_Subscriber,
2000.INS02,Individual Relationship Code,,"18 :Self
19 :Child
01: Spouse
03 : Father or Mother",Enr_Member.Relationship_Code,
2000.INS03,Maintenance Type Code,,"001 = Change, 021 = Addition, 024 = Cancellation or Termination, 025 = Reinstatement/Benefit Plan change, 030 = Audit or Compare",Enr_Member.Maintenance_Type_Code,
...
XN=Notification Only (Audit)",Enr_Member.Maintenance_Reason_Code,
2000.INS05,Benefit Status Code,,"A: Active
C: Consolidated Omnibus Budget Reconciliation Act
(COBRA)
S: Surviving Insured
T: Tax Equity and Fiscal Responsibility Act (TEFRA)",Enr_Member.Benefit_Status_Code,
2000.INS06,MEDICARE STATUS CODE,,,,
2000.INS06-1,Medicare Plan Code,,"A =  Medicare Part A
B =  Medicare Part B
C = Medicare Part A and B
D = Medicare
E  = No Medicare",Enr_Member.Medicare_Plan_Code,
2000.INS06-2,Eligibility Reason Code,,"0 Age
1 Disability
2 End Stage Renal Disease (ESRD)",Enr_Member.Eligibility_Reason_Code,
...
9 Layoff
10 Leave of Absence
ZZ Mutually Defined",Enr_Member.COBRA_Event_Code,
...
TE - Terminate",Enr_Member.Employment_Status_Code,
2000.INS09,Student Status Code,,"F - Full-Time
N - Not a Student
P - Part-Time",Enr_Member.Student_Status_Code,
2000.INS10,Handicap Indicator,,"Y = Yes
N= No",Enr_Member.Handicap_Status_Code,
2000.INS11,DTP Format Qualifier,,D8 Date Expressed in Format CCYYMMDD,,
2000.INS12,Insured Individual Death Date,Date of Death,,Enr_Member.Date_Of_Death,
...
2000.REF02,Reference Identification,Subscriber Identifier,,Enr_Member.Subscriber_Identifier,
2000.REF,Member Policy Number,,,,
2000.REF01,Reference Identification Qualifier,,1L Group or Policy Number,,
2000.REF02,Reference Identification,Member Group or Policy Number,,Enr_Member.Group_Or_Policy_Number,
2000.REF,Member Supplemental Identifier Segment repeat = 13,A record is inserted into Enr_Member_Supplemental_Identification table for each repetition of 2000.REF segment.,,,
...
ZZ Mutually Defined",Enr_Member_Supplemental_Identification.Identification_Type,
2000.REF02,Reference Identification,Member Supplemental Identifier,,Enr_Member_Supplemental_Identification.Member_Supplemental_Identifier,
2000.DTP,Member Level Dates,,,,
2000.DTP01,Date Time Qualifier,,,,
2000.DTP02,Date Time Period Format Qualifier,D8 Date Expressed in Format CCYYMMDD,,,
...
2100A.NM103,Subscriber Last Name,Members last name,,Enr_Member.Last_Name,
2100A.NM104,Subscriber First Name,Members first name,,Enr_Member.First_Name,
2100A.NM105,Subscriber Middle Name,Members middle initial,,Enr_Member.Middle_Name,
2100A.NM106,Subscriber Name Prefix,Member Name Prefix,,Enr_Member.Prefix,
2100A.NM107,Subscriber Name Suffix,Member Name Suffix,,Enr_Member.Suffix,
2100A.NM108,Identification Code Qualifier,,"34 Social Security Number
ZZ Mutually Defined",,
2100A.NM109,Subscriber Identifier,,,Enr_Member.Identification_Code,
2100A.PER,Members Communications Numbers,A record is inserted into Enr_Communication_Numbers table for Members Communications Numbers (2100A.PER),,,
2100A.PER01,Contact Function Code,,IP : Insured Party,,Populate it as 'Insured Party'
...
2100A.PER04,Communication Number,,,Enr_Communication_Numbers.E-Mail_Address,If 2100A.PER03 is EM
.,,,,Enr_Communication_Numbers.Alternate_TeIepnone,If 2100A.PER03 is AP
.,,,,Enr_Communication_Numbers.Beeper,If 2100A.PER03 is BN
.,,,,Enr_Communication_Numbers.Cellular_Phone,If 2100A.PER03 is CP
.,,,,Enr_Communication_Numbers.Telephone_Extension,If 2100A.PER03 is EX
.,,,,Enr_Communication_Numbers.Facsimile,If 2100A.PER03 is FX
.,,,,Enr_Communication_Numbers.Home_Phone,If 2100A.PER03 is HP
.,,,,Enr_Communication_Numbers.Telephone,If 2100A.PER03 is TE
.,,,,Enr_Communication_Numbers.Work_Phone,If 2100A.PER03 is WP
...
TE Telephone
WP Work Phone Number",,
2100A.PER06,Communication Number,,,Enr_Communication_Numbers.E-Mail_Address,If 2100A.PER05 is EM
.,,,,Enr_Communication_Numbers.Alternate_TeIepnone,If 2100A.PER05 is AP
.,,,,Enr_Communication_Numbers.Beeper,If 2100A.PER05 is BN
.,,,,Enr_Communication_Numbers.Cellular_Phone,If 2100A.PER05 is CP
.,,,,Enr_Communication_Numbers.Telephone_Extension,If 2100A.PER05 is EX
.,,,,Enr_Communication_Numbers.Facsimile,If 2100A.PER05 is FX
.,,,,Enr_Communication_Numbers.Home_Phone,If 2100A.PER05 is HP
.,,,,Enr_Communication_Numbers.Telephone,If 2100A.PER05 is TE
.,,,,Enr_Communication_Numbers.Work_Phone,If 2100A.PER05 is WP
...
TE Telephone
WP Work Phone Number",,
2100A.PER08,Communication Number,,,Enr_Communication_Numbers.E-Mail_Address,If 2100A.PER07 is EM
.,,,,Enr_Communication_Numbers.Alternate_TeIepnone,If 2100A.PER07 is AP
.,,,,Enr_Communication_Numbers.Beeper,If 2100A.PER07 is BN
.,,,,Enr_Communication_Numbers.Cellular_Phone,If 2100A.PER07 is CP
.,,,,Enr_Communication_Numbers.Telephone_Extension,If 2100A.PER07 is EX
.,,,,Enr_Communication_Numbers.Facsimile,If 2100A.PER07 is FX
.,,,,Enr_Communication_Numbers.Home_Phone,If 2100A.PER07 is HP
.,,,,Enr_Communication_Numbers.Telephone,If 2100A.PER07 is TE
.,,,,Enr_Communication_Numbers.Work_Phone,If 2100A.PER07 is WP
2100A.N3,Members Residence street Address,A record is inserted into Enr_Address table for Members Residence address (2100A.N3),,,
2100A.N301,Members Address Line 1,,,Enr_Address.Address_Line_1,
2100A.N302,Members Address Line 2,,,Enr_Address.Address_Line_2,
2100A.N4,"Members City, State, and Zip Code",,,,
2100A.N401,City Name,,,Enr_Address.City,
2100A.N402,State or Province Code,,,Enr_Address.State_Or_Province_Code,
2100A.N403,Postal Code,,,Enr_Address.Postal_Code,
2100A.N404,Country Code,,,Enr_Address.Country_Code,
2100A.N405,Location Qualifier,,"60 Area
CY County/Parish",,
2100A.N406,Location Identifier,,,Enr_Address.Location_Identification,
...
2100A.DMG02,Member Birth Date,Member Birth Date,,Enr_Member.Date_Of_Birth,
2100A.DMG03,Gender Code,,"F : Female
M :Male
U :Unknown",Enr_Member.Gender_Code,
2100A.DMG04,Marital Status Code,,"B :Registered Domestic Partner
D :Divorced
I :Single
M : Married
R :Unreported
S :Separated",Enr_Member.Marital_Status_Code,
2100A.DMG05,"COMPOSITE RACE OR ETHNICITY
INFORMATION",To send general and detailed information on race or ethnicity,,A record is inserted into Member_Race_Or_Ethnicity table for each occurrence of 2100A.DMG05,
2100A.DMG05-1,Race or Ethnicity Code,,,Enr_Member_Race_Or_Ethnicity.Race_Or_Ethnicity_Code,
2100A.DMG05-2,Race or Ethnicity Code,,RET : Classification of Race or Ethnicity,,
2100A.DMG05-3,Industry Code,Classification of Race or Ethnicity,,Enr_Member_Race_Or_Ethnicity.Race_Or_Ethnicity_Classification,
...
7 U.S. Citizen - Resident",Enr_Member.Citizenship_Status_Code,
...
2100A.HLH01,Health Related Code,,"U 	Unknown
N 	None
S 	Substance Abuse
T 	Tobacco Use
X 	Tobacco and Substance Abuse",Enr_Member.Smoking _ Status_Code,
2100A.HLH02,Height,Member Height,,,
2100A.HLH03,Weight,Member Weight,,,
2100A.LUI,Member Language   Segment Repeat  > 1,A record is inserted into Enr_Member_Language table for each repetition of Member Language segment   (2100A.LUI),,,
2100A.LUI01,Identification Code Qualifier,,"LD NISO Z39.53 Language Codes
LE ISO 639 Language Codes",,
2100A.LUI02,Identification Code,Language Code,,Enr_Member_Language.Language_Code,
2100A.LUI03,Description,Language Description,,Enr_Member_Language.Language_Description,
2100A.LUI04,Language Indicator,Language Use Indicator,"5 = Language Reading
6 = Language Writing
7 = Language Speaking
8 = Native Language",Enr_Member_Language.Language_Indicator,
...
2100C — MEMBER MAILING ADDRESS Loop Repeat: 1   A record is inserted into Enr_Address table for Member Mailing address (2100C),,,,,
...
2100C.N301,Member Address Line,,,Enr_Address.Address_Line_1,
2100C.N302,Member Address Line 2,,,Enr_Address.Address_Line_2,
2100C.N4,"MEMBER MAIL CITY, STATE, ZIP CODE",,,,
2100C.N401,Member City Name,,,Enr_Address.City,
2100C.N402,Member State Code,,,Enr_Address.State_Or_Province_Code,
2100C.N403,Member ZIP Code,,,Enr_Address.Postal_Code,
2100C.N404,Member Country Code,,,Enr_Address.Country_Code,
2100F — CUSTODIAL PARENT Loop Repeat: 1   A record is inserted into Enr_Member_Custodial_Parent table for 2100F loop.,,,,,
...
2100F.NM103,Name Last or Organization Name,Custodial Parent Last Name,,Enr_Member_Custodial_Parent.Last_Name,
2100F.NM104,Name First,Custodial Parent  First Name,,Enr_Member_Custodial_Parent.First_Name,
2100F.NM105,Name Middle,Custodial Parent Middle Name,,Enr_Member_Custodial_Parent.Middle_Name,
2100F.NM106,Name Prefix,,,Enr_Member_Custodial_Parent.Prefix,
2100F.NM107,Name Suffix,,,Enr_Member_Custodial_Parent.Suffix,
2100F.NM108,Identification Code Qualifier,,"34 = Social Security Number
ZZ Mutually Defined",,
2100F.NM109,Subscriber Identifier,Custodial Parent Identifier,,Enr_Member_Custodial_Parent.Identification_Code,
...
TE Telephone
WP Work Phone Number",,
2100F.PER04,Communication Number,,,Enr_Communication_Numbers.E-Mail_Address,If 2100F.PER03 is EM
.,,,,Enr_Communication_Numbers.Alternate_TeIepnone,If 2100F.PER03 is AP
.,,,,Enr_Communication_Numbers.Beeper,If 2100F.PER03 is BN
.,,,,Enr_Communication_Numbers.Cellular_Phone,If 2100F.PER03 is CP
.,,,,Enr_Communication_Numbers.Telephone_Extension,If 2100F.PER03 is EX
.,,,,Enr_Communication_Numbers.Facsimile,If 2100F.PER03 is FX
.,,,,Enr_Communication_Numbers.Home_Phone,If 2100F.PER03 is HP
.,,,,Enr_Communication_Numbers.Telephone,If 2100F.PER03 is TE
.,,,,Enr_Communication_Numbers.Work_Phone,If 2100F.PER03 is WP
...
TE Telephone
WP Work Phone Number",,
2100F.PER06,Communication Number,,,Enr_Communication_Numbers.E-Mail_Address,If 2100F.PER05 is EM
.,,,,Enr_Communication_Numbers.Alternate_TeIepnone,If 2100F.PER05 is AP
.,,,,Enr_Communication_Numbers.Beeper,If 2100F.PER05 is BN
.,,,,Enr_Communication_Numbers.Cellular_Phone,If 2100F.PER05 is CP
.,,,,Enr_Communication_Numbers.Telephone_Extension,If 2100F.PER05 is EX
.,,,,Enr_Communication_Numbers.Facsimile,If 2100F.PER05 is FX
.,,,,Enr_Communication_Numbers.Home_Phone,If 2100F.PER05 is HP
.,,,,Enr_Communication_Numbers.Telephone,If 2100F.PER05 is TE
.,,,,Enr_Communication_Numbers.Work_Phone,If 2100F.PER05 is WP
...
TE Telephone
WP Work Phone Number",,
2100F.PER08,Communication Number,,,Enr_Communication_Numbers.E-Mail_Address,If 2100F.PER07 is EM
.,,,,Enr_Communication_Numbers.Alternate_TeIepnone,If 2100F.PER07 is AP
.,,,,Enr_Communication_Numbers.Beeper,If 2100F.PER07 is BN
.,,,,Enr_Communication_Numbers.Cellular_Phone,If 2100F.PER07 is CP
.,,,,Enr_Communication_Numbers.Telephone_Extension,If 2100F.PER07 is EX
.,,,,Enr_Communication_Numbers.Facsimile,If 2100F.PER07 is FX
.,,,,Enr_Communication_Numbers.Home_Phone,If 2100F.PER07 is HP
.,,,,Enr_Communication_Numbers.Telephone,If 2100F.PER07 is TE
.,,,,Enr_Communication_Numbers.Work_Phone,If 2100F.PER07 is WP
2100F.N3,Custodial Parent Street Address,A record is inserted into Address table for Custodial Parent Address,,,
2100F.N301,Address Information,,,Enr_Address.Address_Line_1,
2100F.N302,Address Information,,,Enr_Address.Address_Line_2,
2100F.N4,"Custodial Parent City, State, and Zip Code",,,,
2100F.N401,City Name,Member's City Name,,Enr_Address.City,
2100F.N402,State or Province Code,State,,Enr_Address.State_Or_Province_Code,
2100F.N403,Postal Code,Postal Code,,Enr_Address.Postal_Code,
2100F.N404,Country Code,"If Country Code Not Equal to USA, then populate element",,Enr_Address.Country_Code,
2100F.N407,Country Subdivision Code,,,,
2100G — RESPONSIBLE PERSON Loop Repeat: 13     A record is inserted into Enr_Member_Responsible_Party  table  for each occrence of 2100G loop.,,,,,
...
EXS : Ex-spouse",Enr_Member_Responsible_Party.Member_Responsible_Party_Type,
2100G.NM102,Entity Type Qualifier,,1 = Person,,
2100G.NM103,Name Last or Organization Name,Responsible Person Last Name,,Enr_Member_Responsible_Party.Last_Name,
2100G.NM104,Name First,Responsible Person  First Name,,Enr_Member_Responsible_Party.First_Name,
2100G.NM105,Name Middle,Responsible Person Middle Name,,Enr_Member_Responsible_Party.Middle_Name,
2100G.NM106,Name Prefix,,,Enr_Member_Responsible_Party.Prefix,
2100G.NM107,Name Suffix,,,Enr_Member_Responsible_Party.Suffix,
2100G.NM108,Identification Code Qualifier,,"34 : Social Security Number
ZZ Mutually Defined",,
2100G.NM109,Subscriber Identifier,Responsible Party Identifier,,Enr_Member_Responsible_Party.Identification_Code,
...
TE Telephone
WP Work Phone Number",,
2100G.PER04,Communication Number,,,Enr_Communication_Numbers.E-Mail_Address,If 2100G.PER03 is EM
.,,,,Enr_Communication_Numbers.Alternate_TeIepnone,If 2100G.PER03 is AP
.,,,,Enr_Communication_Numbers.Beeper,If 2100G.PER03 is BN
.,,,,Enr_Communication_Numbers.Cellular_Phone,If 2100G.PER03 is CP
.,,,,Enr_Communication_Numbers.Telephone_Extension,If 2100G.PER03 is EX
.,,,,Enr_Communication_Numbers.Facsimile,If 2100G.PER03 is FX
.,,,,Enr_Communication_Numbers.Home_Phone,If 2100G.PER03 is HP
.,,,,Enr_Communication_Numbers.Telephone,If 2100G.PER03 is TE
.,,,,Enr_Communication_Numbers.Work_Phone,If 2100G.PER03 is WP
...
TE Telephone
WP Work Phone Number",,
2100G.PER06,Communication Number,,,Enr_Communication_Numbers.E-Mail_Address,If 2100G.PER05 is EM
.,,,,Enr_Communication_Numbers.Alternate_TeIepnone,If 2100G.PER05 is AP
.,,,,Enr_Communication_Numbers.Beeper,If 2100G.PER05 is BN
.,,,,Enr_Communication_Numbers.Cellular_Phone,If 2100G.PER05 is CP
.,,,,Enr_Communication_Numbers.Telephone_Extension,If 2100G.PER05 is EX
.,,,,Enr_Communication_Numbers.Facsimile,If 2100G.PER05 is FX
.,,,,Enr_Communication_Numbers.Home_Phone,If 2100G.PER05 is HP
.,,,,Enr_Communication_Numbers.Telephone,If 2100G.PER05 is TE
.,,,,Enr_Communication_Numbers.Work_Phone,If 2100G.PER05 is WP
...
TE Telephone
WP Work Phone Number",,
2100G.PER08,Communication Number,,,Enr_Communication_Numbers.E-Mail_Address,If 2100G.PER07 is EM
.,,,,Enr_Communication_Numbers.Alternate_TeIepnone,If 2100G.PER07 is AP
.,,,,Enr_Communication_Numbers.Beeper,If 2100G.PER07 is BN
.,,,,Enr_Communication_Numbers.Cellular_Phone,If 2100G.PER07 is CP
.,,,,Enr_Communication_Numbers.Telephone_Extension,If 2100G.PER07 is EX
.,,,,Enr_Communication_Numbers.Facsimile,If 2100G.PER07 is FX
.,,,,Enr_Communication_Numbers.Home_Phone,If 2100G.PER07 is HP
.,,,,Enr_Communication_Numbers.Telephone,If 2100G.PER07 is TE
.,,,,Enr_Communication_Numbers.Work_Phone,If 2100G.PER07 is WP
2100G.N3,Responsible Person Street Address,A record is inserted into Enr_Address  table for Responsible person Address (2100G.N3/N4),,,
2100G.N301,Address Information,,,Enr_Address.Address_Line_1,
2100G.N302,Address Information,,,Enr_Address.Address_Line_2,
2100G.N4,"Responsible Person City, State, and Zip Code",,,,
2100G.N401,City Name,City Name,,Enr_Address.City,
2100G.N402,State or Province Code,State,,Enr_Address.State_Or_Province_Code,
2100G.N403,Postal Code,Postal Code,,Enr_Address.Postal_Code,
2100G.N404,Country Code,"If Country Code Not Equal to USA, then populate element",,Enr_Address.Country_Code,
...
2300 — HEALTH COVERAGE Loop Repeat: 99    A record is inserted into Enr_Member_Plan_Selection  table  for each 2300 loop.,,,,,
...
032 Employee Information Not Applicable",Enr_Member_Plan_Selection.Maintenance_Type_Code,
2300.HD03,Insurance Line Code,,"HLT = Health
refer 4.3 for valid values.
Commony used are HLT,DEN,VIS",Enr_Member_Plan_Selection.Insurance_Line_Code,
2300.HD04,Plan Coverage Description,,,Enr_Member_Plan_Selection.Plan_Coverage_Description,
...
SPO Spouse Only
TWO Two Party",Enr_Member_Plan_Selection.Coverage_Level_Code,
2300.HD09,Yes/No Condition or Response Code,Late Enrollment Indicator,,Enr_Member_Plan_Selection.Late_Enrollment_Indicator,
...
2300.DTP03,Coverage Period,,,Enr_Member_Plan_Selection.Benefit_Begin_Date,If 2300.DTP01 is 348
,,,,Enr_Member_Plan_Selection.Benefit_End_Date,"If 2300.DTP01 is 349,
Hardcode as 30000101 if DTP*349 is not present"
,,,,Enr_Member_Plan_Selection.Last_Premium_Paid_Date,If 2300.DTP01 is 543
,,,,Enr_Member_Plan_Selection.Maintenance_Effective_Date,If 2300.DTP01 is 303
...
P3 Premium Amount
R Spend Down",,
2300.AMT02,Monetary Amount,Contract Amount,,Enr_Member_Plan_Selection.Premium_Amount,Map the first instance of  2300.AMT01 = P3.
...
ZX County Code
ZZ Mutually Defined",,
2300.REF02,Reference Identification,Member Group or Policy Number,,Enr_Member_Plan_Selection.Group_Or_PoIicy_Number,Map the first instance of 2300.REF01 = 1L
.,,,,Enr_Member_Plan_Selection.Class_Of_Contract_Code,Map the first instance of 2300.REF01 = CE
...
2310.PLA03,Date,,Provider Effective Date,,
...
T Tertiary
U Unknown",,
2320.COB02,Reference Identification,Member Group or Policy Number,,,
...
ZZ Mutually Defined",,
2320.REF02,Reference Identification,Member Group or Policy Number,,,
...
2320.DTP03,Date Time Period,Coordination of Benefit Date,,,
...
2330.NM103,Member Last Name,Coordination of Benefits Insurer Name,,,
2330.NM108,ID Code Qualifier,,"FI: Federal Tax ID
NI: NAIC
XV: CMS Plan ID",,
2330.NM109,ID Code,"Coordination of Benefits Insurer Identification
Code",,,
...
2710 — MEMBER REPORTING CATEGORIES Loop Repeat: >1      A record is inserted into  Enr_Member_Reporting_category  table  for each 2710 loop.,,,,,
...
2750.N102,Name,Member Reporting Category Name,,Enr_Member_Reporting_Category.Name,
...
XX2 Service Area Code
YY Geographic Key
ZZ Mutually Defined",Enr_Member_Reporting_Category_Identifiers.Identification_Type,
2750.REF02,Reference Identification,Member Reporting Category Reference ID,,Enr_Member_Reporting_Category_Identifiers.Identification,
...
RD8 : Range of Dates Expressed in Format CCYYMMDD-CCYYMMDD",,
2750.DTP03,,,,Enr_Member_Reporting_Category.Start_Date,"If 2750.DTP02 is D8 populate 2750.DTP02.
If 2750.DTP02 is RD8, populate the first CCYYMMDD"
,Date Time Period,Member Reporting Category Effective Date(s),,Enr_Member_Reporting_Category.End_Date,"If 2750.DTP02 is D8 Leave it blank.
If 2750.DTP02 is RD8, populate the second CCYYMMDD"
...
## Repository/Enrollment/V26.1.1.0/EdifecsProduct_MappingSpec_EnrollmentRepo_834_EDI_to_DFFConversion_V2.0.xlsx — Generic Attributes

```csv
Integration Plus Table  Name.Column Name,Values,Comments
Enr_Member_HCC_ID_LookUp.Submitted_Member_Key,Populated by ODS .Same as Member.Submitted_Member_Key.,
Enr_Member_HCC_ID_LookUp.Member_Hcc_Id,Populated by ODS .,
Enr_Member_HCC_ID_LookUp.Source_Data_Created_Time,Auto populated,
,,
Enr_Member.Submitted_Member_Key,A unique Identifier,
Enr_Member.Residence_Address_key,Enr_Address.Address_Key of the Member residence address(2100A.N3),
Enr_Member.Mailing_Address_Key,Enr_Address.Address_Key of the Member Mailing address(2100C.N3),
Enr_Member.Communication_Key,Enr_Communication_Numbers.Communication_Key of the Member communication numbers(2100C.PER),
Enr_Member.Source_Data_Created_Time,Auto populated,
,,
Enr_Member_Supplemental_Identification.Submitted_Member_Key,Enr_Member.Submitted_Member_Key,
Enr_Member_Supplemental_Identification.Member_Identification_Key,Sequnce number that will be incremented for each occurrence of 2000.REF segment(MEMBER SUPPLEMENTAL IDENTIFIER),
Enr_Member_Supplemental_Identification.Source_Data_Created_Time,Auto populated,
,,
Enr_Member_Plan_Selection.Submitted_Member_Key,Enr_Member.Submitted_Member_Key,
Enr_Member_Plan_Selection.Member_Plan_Selection_Key,Sequnce number that will be incremented for each occurrence of 2300 loop,
Enr_Member_Plan_Selection.Source_Data_Created_Time,Auto populated,
,,
Enr_Address.Submitted_Member_Key,Enr_Member.Submitted_Member_Key,
Enr_Address.Address_Key,Sequnce number that will be incremented for each Address detail inserted into Enr_Address table.,
Enr_Address.Source_Data_Created_Time,Auto populated,
,,
Enr_Communication_Numbers.Submitted_Member_Key,Enr_Member.Submitted_Member_Key,
Enr_Communication_Numbers.Communication_Key,Sequnce number that will be incremented for each Communication inserted into Enr_Communication_Numbers table.,
Enr_Communication_Numbers.Source_Data_Created_Time,Auto populated,
,,
Enr_Member_Race_Or_Ethnicity.Submitted_Member_Key,Enr_Member.Submitted_Member_Key,
Enr_Member_Race_Or_Ethnicity.Member_Race_Or_Ethnicity_Key,Sequnce number that will be incremented for each occurrence of Race or Ethnicity data,
Enr_Member_Race_Or_Ethnicity.Source_Data_Created_Time,Auto populated,
,,
Enr_Member_Language.Submitted_Member_Key,Enr_Member.Submitted_Member_Key,
Enr_Member_Language.Member_Language_Key,Sequnce number that will be incremented for each occurrence of 2100A.LUI Segment,
Enr_Member_Language.Source_Data_Created_Time,Auto populated,
,,
Enr_Member_Responsible_Party.Submitted_Member_Key,Enr_Member.Submitted_Member_Key,
Enr_Member_Responsible_Party.Member_Responsible_Party_Key,Sequnce number that will be incremented for each occurrence of 2100G loop,
Enr_Member_Responsible_Party.Address_Key,Enr_Address.Address_Key of the Responsible person address(2100G.N3),
Enr_Member_Responsible_Party.Communication_Key,Enr_Communication_Numbers.Communication_Key of the Responsible person communication numbers(2100G.PER),
Enr_Member_Responsible_Party.Source_Data_Created_Time,Auto populated,
,,
Enr_Member_Custodial_Parent.Submitted_Member_Key,Enr_Member.Submitted_Member_Key,
Enr_Member_Custodial_Parent.Member_Custodial_Parent_Key,Sequence Number,
Enr_Member_Custodial_Parent.Address_Key,Enr_Address.Address_Key of the Custodial parent address(2100F.N3),
Enr_Member_Custodial_Parent.Communication_Key,Enr_Communication_Numbers.Communication_Key of the Custodial parent communication numbers(2100F.PER),
Enr_Member_Custodial_Parent.Source_Data_Created_Time,Auto populated,
,,
Enr_Member_Reporting_Category_Key.Submitted_Member_Key,Enr_Member.Submitted_Member_Key,
Enr_Member_Reporting_Category_Key.Member_Reporting_Category_Key,Sequnce number that will be incremented for each occurrence of 2710 loop,
Enr_Member_Reporting_Category_Key.Source_Data_Created_Time,Auto populated,
,,
Enr_Member_Reporting_Category_Identifiers.Submitted_Member_Key,Enr_Member.Submitted_Member_Key,
Enr_Member_Reporting_Category_Identifiers.Member_Reporting_Category_Key,Enr_Member_Reporting_Category_Key.Member_Reporting_Category_Key in which  corresponding reporting category is loaded (2750.N102),
Enr_Member_Reporting_Category_Identifiers.Reporting_Category_Identifier_Key,Sequnce number that will be incremented for each occurrence of 2750.REF segment,
Enr_Member_Household_Reporting_Category_Key.Source_Data_Created_Time,Auto populated,
```
